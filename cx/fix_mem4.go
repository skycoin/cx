...
./cx/fix_read.go:31:	return DeserializeUI8(ReadMemory(GetFinalOffset(fp, inp), inp))
./cx/fix_read.go:36:	return DeserializeUI16(ReadMemory(GetFinalOffset(fp, inp), inp))
./cx/fix_read.go:41:	return DeserializeUI32(ReadMemory(GetFinalOffset(fp, inp), inp))
./cx/fix_read.go:46:	return DeserializeUI64(ReadMemory(GetFinalOffset(fp, inp), inp))
