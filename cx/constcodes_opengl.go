...
func init() {
	...
	AddConstCode(CONST_GL_NONE, "gl.NONE", TYPE_I32, FromI32(0))
	...
	AddConstCode(CONST_GL_RED, "gl.RED", TYPE_I32, FromI32(0x1903))
	...
	AddConstCode(CONST_GL_COMPILE_STATUS, "gl.COMPILE_STATUS", TYPE_I32, FromI32(0x8B81))
	AddConstCode(CONST_GL_LINK_STATUS, "gl.LINK_STATUS", TYPE_I32, FromI32(0x8B82))
	AddConstCode(CONST_GL_INFO_LOG_LENGTH, "gl.INFO_LOG_LENGTH", TYPE_I32, FromI32(0x8B84))
	...
	// gl_3_0
	AddConstCode(CONST_GL_RGBA16F, "gl.RGBA16F", TYPE_I32, FromI32(0x881A))
	...
	AddConstCode(CONST_GL_UNSIGNED_INT_24_8, "gl.UNSIGNED_INT_24_8", TYPE_I32, FromI32(0x84FA))
	...
	AddConstCode(CONST_GL_HALF_FLOAT, "gl.HALF_FLOAT", TYPE_I32, FromI32(0x140B))
	AddConstCode(CONST_GL_R8, "gl.R8", TYPE_I32, FromI32(0x8229))
	...
	AddConstCode(CONST_GLFW_OPENGL_PROFILE, "glfw.OpenGLProfile", TYPE_I32, FromI32(139272))
	AddConstCode(CONST_GLFW_OPENGL_COREPROFILE, "glfw.OpenGLCoreProfile", TYPE_I32, FromI32(204801))
	AddConstCode(CONST_GLFW_OPENGL_FORWARD_COMPATIBLE, "glfw.OpenGLForwardCompat", TYPE_I32, FromI32(139270))
	...
	AddConstCode(CONST_GLFW_COCOA_RETINA_FRAMEBUFFER, "glfw.CocoaRetinaFramebuffer", TYPE_I32, FromI32(0x23001))
	AddConstCode(CONST_GLFW_SCALE_TO_MONITOR, "glfw.ScaleToMonitor", TYPE_I32, FromI32(0x2200C))
