...
func opI8ToI16(prgrm *CXProgram) {
	...
	outB0 := FromI16(int16(ReadI8(fp, expr.Inputs[0])))
...
func opI8ToI32(prgrm *CXProgram) {
	...
	outB0 := FromI32(int32(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8ToI64(prgrm *CXProgram) {
	...
	outB0 := FromI64(int64(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8ToUI8(prgrm *CXProgram) {
	...
	outB0 := FromUI8(uint8(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8ToUI16(prgrm *CXProgram) {
	...
	outB0 := FromUI16(uint16(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8ToUI32(prgrm *CXProgram) {
	...
	outB0 := FromUI32(uint32(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8ToUI64(prgrm *CXProgram) {
	...
	outB0 := FromUI64(uint64(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8ToF32(prgrm *CXProgram) {
	...
	outB0 := FromF32(float32(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8ToF64(prgrm *CXProgram) {
	...
	outB0 := FromF64(float64(ReadI8(fp, expr.Inputs[0])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8Add(prgrm *CXProgram) {
	...
	outB0 := FromI8(ReadI8(fp, expr.Inputs[0]) + ReadI8(fp, expr.Inputs[1]))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8Neg(prgrm *CXProgram) {
	...
	outB0 := FromI8(-ReadI8(fp, expr.Inputs[0]))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8Gt(prgrm *CXProgram) {
	...
	outB0 := FromBool(ReadI8(fp, expr.Inputs[0]) > ReadI8(fp, expr.Inputs[1]))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8Rand(prgrm *CXProgram) {
	...
	val0 := int8(0)
	if r > 0 {
		val0 = int8(rand.Intn(r) + int(minimum))
	}

	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), FromI8(val0))
}
...
func opI8Bitshl(prgrm *CXProgram) {
	...
	outB0 := FromI8(ReadI8(fp, expr.Inputs[0]) << uint8(ReadI8(fp, expr.Inputs[1])))
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), outB0)
}
...
func opI8Max(prgrm *CXProgram) {
	...
	inp0 := ReadI8(fp, expr.Inputs[0])
	inp1 := ReadI8(fp, expr.Inputs[1])
	if inp1 > inp0 {
		inp0 = inp1
	}
	WriteMemory(GetFinalOffset(fp, expr.Outputs[0]), FromI8(inp0))
}
