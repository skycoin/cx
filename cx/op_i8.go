...
func opI8ToStr(inputs []CXValue, outputs []CXValue) {
...
func opI8ToI16(inputs []CXValue, outputs []CXValue) {
...
func opI8ToI32(inputs []CXValue, outputs []CXValue) {
...
func opI8ToI64(inputs []CXValue, outputs []CXValue) {
...
func opI8ToUI8(inputs []CXValue, outputs []CXValue) {
...
func opI8ToUI16(inputs []CXValue, outputs []CXValue) {
...
func opI8ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opI8ToUI64(inputs []CXValue, outputs []CXValue) {
...
func opI8ToF32(inputs []CXValue, outputs []CXValue) {
...
func opI8Gt(inputs []CXValue, outputs []CXValue) {
    outV0 := inputs[0].Get_i8() > inputs[1].Get_i8()
...
// equal to operand 2.
func opI8Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i8() >= inputs[1].Get_i8()
    outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than operand 2.
func opI8Lt(inputs []CXValue, outputs []CXValue) {
    outV0 := inputs[0].Get_i8() < inputs[1].Get_i8()
    outputs[0].Set_bool(outV0)
}
...
// to operand 1.
func opI8Lteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i8() <= inputs[1].Get_i8()
    outputs[0].Set_bool(outV0)
}

// The built-in eq function returns true if operand 1 is equal to operand 2.
func opI8Eq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i8() == inputs[1].Get_i8()
    outputs[0].Set_bool(outV0)
}

// The built-in uneq function returns true if operand 1 is different from operand 2.
func opI8Uneq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i8() != inputs[1].Get_i8()
    outputs[0].Set_bool(outV0)
}

// The built-in mod function returns the remainder of operand 1 / operand 2.
func opI8Mod(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i8() % inputs[1].Get_i8()
    outputs[0].Set_i8(outV0)
}

// The built-in rand function returns a pseudo random number in [operand 1, operand 2).
func opI8Rand(inputs []CXValue, outputs []CXValue) {
...
func opI8Bitshl(inputs []CXValue, outputs []CXValue) {
...
// by number of positions specified in operand 2.
func opI8Bitshr(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i8() >> uint8(inputs[1].Get_i8())
    outputs[0].Set_i8(outV0)
}

// The built-in max function returns the biggest of the two operands.
func opI8Max(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_i8()
...
func opI8Min(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_i8()
	inpV1 := inputs[1].Get_i8()
	if inpV1 < inpV0 {
		inpV0 = inpV1
