...
func init() {
	...
	globals.Operator(constants.OP_BOOL_EQUAL, "bool.eq", opBoolEqual, In(ABOOL, ABOOL), Out(ABOOL), constants.TYPE_BOOL, constants.OP_EQUAL)
	globals.Operator(constants.OP_BOOL_UNEQUAL, "bool.uneq", opBoolUnequal, In(ABOOL, ABOOL), Out(ABOOL), constants.TYPE_BOOL, constants.OP_UNEQUAL)
    ...
    globals.Operator(constants.OP_I8_EQ, "i8.eq", opI8Eq, In(AI8, AI8), Out(ABOOL), constants.TYPE_I8, constants.OP_EQUAL)
	globals.Operator(constants.OP_I8_UNEQ, "i8.uneq", opI8Uneq, In(AI8, AI8), Out(ABOOL), constants.TYPE_I8, constants.OP_UNEQUAL)
    globals.Operator(constants.OP_I8_BITAND, "i8.bitand", opI8Bitand, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_BITAND)
	globals.Operator(constants.OP_I8_BITOR, "i8.bitor", opI8Bitor, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_BITOR)
	globals.Operator(constants.OP_I8_BITXOR, "i8.bitxor", opI8Bitxor, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_BITXOR)
	globals.Operator(constants.OP_I8_BITCLEAR, "i8.bitclear", opI8Bitclear, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_BITCLEAR)
	globals.Operator(constants.OP_I8_BITSHL, "i8.bitshl", opI8Bitshl, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_BITSHL)
    globals.Operator(constants.OP_I8_BITSHR, "i8.bitshr", opI8Bitshr, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_BITSHR)
    globals.Operator(constants.OP_I8_ADD, "i8.add", opI8Add, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_ADD)
	globals.Operator(constants.OP_I8_SUB, "i8.sub", opI8Sub, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_SUB)
	globals.Operator(constants.OP_I8_NEG, "i8.neg", opI8Neg, In(AI8), Out(AI8), constants.TYPE_I8, constants.OP_NEG)
	globals.Operator(constants.OP_I8_MUL, "i8.mul", opI8Mul, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_MUL)
	globals.Operator(constants.OP_I8_DIV, "i8.div", opI8Div, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_DIV)
	globals.Operator(constants.OP_I8_MOD, "i8.mod", opI8Mod, In(AI8, AI8), Out(AI8), constants.TYPE_I8, constants.OP_MOD)
	globals.Operator(constants.OP_I8_GT, "i8.gt", opI8Gt, In(AI8, AI8), Out(ABOOL), constants.TYPE_I8, constants.OP_GT)
	globals.Operator(constants.OP_I8_GTEQ, "i8.gteq", opI8Gteq, In(AI8, AI8), Out(ABOOL), constants.TYPE_I8, constants.OP_GTEQ)
	globals.Operator(constants.OP_I8_LT, "i8.lt", opI8Lt, In(AI8, AI8), Out(ABOOL), constants.TYPE_I8, constants.OP_LT)
	globals.Operator(constants.OP_I8_LTEQ, "i8.lteq", opI8Lteq, In(AI8, AI8), Out(ABOOL), constants.TYPE_I8, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_I16_EQ, "i16.eq", opI16Eq, In(AI16, AI16), Out(ABOOL), constants.TYPE_I16, constants.OP_EQUAL)
	globals.Operator(constants.OP_I16_UNEQ, "i16.uneq", opI16Uneq, In(AI16, AI16), Out(ABOOL), constants.TYPE_I16, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_I16_BITAND, "i16.bitand", opI16Bitand, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_BITAND)
	globals.Operator(constants.OP_I16_BITOR, "i16.bitor", opI16Bitor, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_BITOR)
	globals.Operator(constants.OP_I16_BITXOR, "i16.bitxor", opI16Bitxor, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_BITXOR)
	globals.Operator(constants.OP_I16_BITCLEAR, "i16.bitclear", opI16Bitclear, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_BITCLEAR)
	globals.Operator(constants.OP_I16_BITSHL, "i16.bitshl", opI16Bitshl, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_BITSHL)
	globals.Operator(constants.OP_I16_BITSHR, "i16.bitshr", opI16Bitshr, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_BITSHR)
	globals.Operator(constants.OP_I16_ADD, "i16.add", opI16Add, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_ADD)
	globals.Operator(constants.OP_I16_SUB, "i16.sub", opI16Sub, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_SUB)
	globals.Operator(constants.OP_I16_NEG, "i16.neg", opI16Neg, In(AI16), Out(AI16), constants.TYPE_I16, constants.OP_NEG)
	globals.Operator(constants.OP_I16_MUL, "i16.mul", opI16Mul, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_MUL)
	globals.Operator(constants.OP_I16_DIV, "i16.div", opI16Div, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_DIV)
	globals.Operator(constants.OP_I16_MOD, "i16.mod", opI16Mod, In(AI16, AI16), Out(AI16), constants.TYPE_I16, constants.OP_MOD)
	globals.Operator(constants.OP_I16_GT, "i16.gt", opI16Gt, In(AI16, AI16), Out(ABOOL), constants.TYPE_I16, constants.OP_GT)
	globals.Operator(constants.OP_I16_GTEQ, "i16.gteq", opI16Gteq, In(AI16, AI16), Out(ABOOL), constants.TYPE_I16, constants.OP_GTEQ)
	globals.Operator(constants.OP_I16_LT, "i16.lt", opI16Lt, In(AI16, AI16), Out(ABOOL), constants.TYPE_I16, constants.OP_LT)
	globals.Operator(constants.OP_I16_LTEQ, "i16.lteq", opI16Lteq, In(AI16, AI16), Out(ABOOL), constants.TYPE_I16, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_I32_EQ, "i32.eq", opI32Eq, In(AI32, AI32), Out(ABOOL), constants.TYPE_I32, constants.OP_EQUAL)
	globals.Operator(constants.OP_I32_UNEQ, "i32.uneq", opI32Uneq, In(AI32, AI32), Out(ABOOL), constants.TYPE_I32, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_I32_BITAND, "i32.bitand", opI32Bitand, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_BITAND)
	globals.Operator(constants.OP_I32_BITOR, "i32.bitor", opI32Bitor, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_BITOR)
	globals.Operator(constants.OP_I32_BITXOR, "i32.bitxor", opI32Bitxor, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_BITXOR)
	globals.Operator(constants.OP_I32_BITCLEAR, "i32.bitclear", opI32Bitclear, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_BITCLEAR)
	globals.Operator(constants.OP_I32_BITSHL, "i32.bitshl", opI32Bitshl, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_BITSHL)
	globals.Operator(constants.OP_I32_BITSHR, "i32.bitshr", opI32Bitshr, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_BITSHR)
    globals.Operator(constants.OP_I32_ADD, "i32.add", opI32Add, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_ADD)
	globals.Operator(constants.OP_I32_SUB, "i32.sub", opI32Sub, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_SUB)
	globals.Operator(constants.OP_I32_NEG, "i32.neg", opI32Neg, In(AI32), Out(AI32), constants.TYPE_I32, constants.OP_NEG)
	globals.Operator(constants.OP_I32_MUL, "i32.mul", opI32Mul, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_MUL)
	globals.Operator(constants.OP_I32_DIV, "i32.div", opI32Div, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_DIV)
	globals.Operator(constants.OP_I32_MOD, "i32.mod", opI32Mod, In(AI32, AI32), Out(AI32), constants.TYPE_I32, constants.OP_MOD)
	globals.Operator(constants.OP_I32_GT, "i32.gt", opI32Gt, In(AI32, AI32), Out(ABOOL), constants.TYPE_I32, constants.OP_GT)
	globals.Operator(constants.OP_I32_GTEQ, "i32.gteq", opI32Gteq, In(AI32, AI32), Out(ABOOL), constants.TYPE_I32, constants.OP_GTEQ)
	globals.Operator(constants.OP_I32_LT, "i32.lt", opI32Lt, In(AI32, AI32), Out(ABOOL), constants.TYPE_I32, constants.OP_LT)
	globals.Operator(constants.OP_I32_LTEQ, "i32.lteq", opI32Lteq, In(AI32, AI32), Out(ABOOL), constants.TYPE_I32, constants.OP_LTEQ)
    ...
    globals.Operator(constants.OP_I64_EQ, "i64.eq", opI64Eq, In(AI64, AI64), Out(ABOOL), constants.TYPE_I64, constants.OP_EQUAL)
	globals.Operator(constants.OP_I64_UNEQ, "i64.uneq", opI64Uneq, In(AI64, AI64), Out(ABOOL), constants.TYPE_I64, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_I64_BITAND, "i64.bitand", opI64Bitand, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_BITAND)
	globals.Operator(constants.OP_I64_BITOR, "i64.bitor", opI64Bitor, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_BITOR)
	globals.Operator(constants.OP_I64_BITXOR, "i64.bitxor", opI64Bitxor, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_BITXOR)
	globals.Operator(constants.OP_I64_BITCLEAR, "i64.bitclear", opI64Bitclear, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_BITCLEAR)
    globals.Operator(constants.OP_I64_BITSHL, "i64.bitshl", opI64Bitshl, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_BITSHL)
	globals.Operator(constants.OP_I64_BITSHR, "i64.bitshr", opI64Bitshr, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_BITSHR)
    globals.Operator(constants.OP_I64_ADD, "i64.add", opI64Add, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_ADD)
	globals.Operator(constants.OP_I64_SUB, "i64.sub", opI64Sub, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_SUB)
	globals.Operator(constants.OP_I64_NEG, "i64.neg", opI64Neg, In(AI64), Out(AI64), constants.TYPE_I64, constants.OP_NEG)
	globals.Operator(constants.OP_I64_MUL, "i64.mul", opI64Mul, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_MUL)
	globals.Operator(constants.OP_I64_DIV, "i64.div", opI64Div, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_DIV)
	globals.Operator(constants.OP_I64_MOD, "i64.mod", opI64Mod, In(AI64, AI64), Out(AI64), constants.TYPE_I64, constants.OP_MOD)
	globals.Operator(constants.OP_I64_GT, "i64.gt", opI64Gt, In(AI64, AI64), Out(ABOOL), constants.TYPE_I64, constants.OP_GT)
	globals.Operator(constants.OP_I64_GTEQ, "i64.gteq", opI64Gteq, In(AI64, AI64), Out(ABOOL), constants.TYPE_I64, constants.OP_GTEQ)
	globals.Operator(constants.OP_I64_LT, "i64.lt", opI64Lt, In(AI64, AI64), Out(ABOOL), constants.TYPE_I64, constants.OP_LT)
	globals.Operator(constants.OP_I64_LTEQ, "i64.lteq", opI64Lteq, In(AI64, AI64), Out(ABOOL), constants.TYPE_I64, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_UI8_EQ, "ui8.eq", opUI8Eq, In(AUI8, AUI8), Out(ABOOL), constants.TYPE_UI8, constants.OP_EQUAL)
	globals.Operator(constants.OP_UI8_UNEQ, "ui8.uneq", opUI8Uneq, In(AUI8, AUI8), Out(ABOOL), constants.TYPE_UI8, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_UI8_BITAND, "ui8.bitand", opUI8Bitand, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_BITAND)
	globals.Operator(constants.OP_UI8_BITOR, "ui8.bitor", opUI8Bitor, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_BITOR)
    globals.Operator(constants.OP_UI8_BITXOR, "ui8.bitxor", opUI8Bitxor, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_BITXOR)
	globals.Operator(constants.OP_UI8_BITCLEAR, "ui8.bitclear", opUI8Bitclear, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_BITCLEAR)
	globals.Operator(constants.OP_UI8_BITSHL, "ui8.bitshl", opUI8Bitshl, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_BITSHL)
	globals.Operator(constants.OP_UI8_BITSHR, "ui8.bitshr", opUI8Bitshr, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_BITSHR)
	globals.Operator(constants.OP_UI8_ADD, "ui8.add", opUI8Add, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_ADD)
	globals.Operator(constants.OP_UI8_SUB, "ui8.sub", opUI8Sub, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_SUB)
	globals.Operator(constants.OP_UI8_MUL, "ui8.mul", opUI8Mul, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_MUL)
	globals.Operator(constants.OP_UI8_DIV, "ui8.div", opUI8Div, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_DIV)
	globals.Operator(constants.OP_UI8_MOD, "ui8.mod", opUI8Mod, In(AUI8, AUI8), Out(AUI8), constants.TYPE_UI8, constants.OP_MOD)
	globals.Operator(constants.OP_UI8_GT, "ui8.gt", opUI8Gt, In(AUI8, AUI8), Out(ABOOL), constants.TYPE_UI8, constants.OP_GT)
	globals.Operator(constants.OP_UI8_GTEQ, "ui8.gteq", opUI8Gteq, In(AUI8, AUI8), Out(ABOOL), constants.TYPE_UI8, constants.OP_GTEQ)
	globals.Operator(constants.OP_UI8_LT, "ui8.lt", opUI8Lt, In(AUI8, AUI8), Out(ABOOL), constants.TYPE_UI8, constants.OP_LT)
	globals.Operator(constants.OP_UI8_LTEQ, "ui8.lteq", opUI8Lteq, In(AUI8, AUI8), Out(ABOOL), constants.TYPE_UI8, constants.OP_LTEQ)
    ...
    globals.Operator(constants.OP_UI16_EQ, "ui16.eq", opUI16Eq, In(AUI16, AUI16), Out(ABOOL), constants.TYPE_UI16, constants.OP_EQUAL)
    globals.Operator(constants.OP_UI16_UNEQ, "ui16.uneq", opUI16Uneq, In(AUI16, AUI16), Out(ABOOL), constants.TYPE_UI16, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_UI16_BITAND, "ui16.bitand", opUI16Bitand, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_BITAND)
	globals.Operator(constants.OP_UI16_BITOR, "ui16.bitor", opUI16Bitor, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_BITOR)
	globals.Operator(constants.OP_UI16_BITXOR, "ui16.bitxor", opUI16Bitxor, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_BITXOR)
	globals.Operator(constants.OP_UI16_BITCLEAR, "ui16.bitclear", opUI16Bitclear, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_BITCLEAR)
	globals.Operator(constants.OP_UI16_BITSHL, "ui16.bitshl", opUI16Bitshl, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_BITSHL)
	globals.Operator(constants.OP_UI16_BITSHR, "ui16.bitshr", opUI16Bitshr, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_BITSHR)
	globals.Operator(constants.OP_UI16_ADD, "ui16.add", opUI16Add, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_ADD)
	globals.Operator(constants.OP_UI16_SUB, "ui16.sub", opUI16Sub, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_SUB)
	globals.Operator(constants.OP_UI16_MUL, "ui16.mul", opUI16Mul, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_MUL)
	globals.Operator(constants.OP_UI16_DIV, "ui16.div", opUI16Div, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_DIV)
	globals.Operator(constants.OP_UI16_MOD, "ui16.mod", opUI16Mod, In(AUI16, AUI16), Out(AUI16), constants.TYPE_UI16, constants.OP_MOD)
	globals.Operator(constants.OP_UI16_GT, "ui16.gt", opUI16Gt, In(AUI16, AUI16), In(ABOOL), constants.TYPE_UI16, constants.OP_GT)
	globals.Operator(constants.OP_UI16_GTEQ, "ui16.gteq", opUI16Gteq, In(AUI16, AUI16), Out(ABOOL), constants.TYPE_UI16, constants.OP_GTEQ)
	globals.Operator(constants.OP_UI16_LT, "ui16.lt", opUI16Lt, In(AUI16, AUI16), Out(ABOOL), constants.TYPE_UI16, constants.OP_LT)
	globals.Operator(constants.OP_UI16_LTEQ, "ui16.lteq", opUI16Lteq, In(AUI16, AUI16), Out(ABOOL), constants.TYPE_UI16, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_UI32_EQ, "ui32.eq", opUI32Eq, In(AUI32, AUI32), Out(ABOOL), constants.TYPE_UI32, constants.OP_EQUAL)
	globals.Operator(constants.OP_UI32_UNEQ, "ui32.uneq", opUI32Uneq, In(AUI32, AUI32), Out(ABOOL), constants.TYPE_UI32, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_UI32_BITAND, "ui32.bitand", opUI32Bitand, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_BITAND)
	globals.Operator(constants.OP_UI32_BITOR, "ui32.bitor", opUI32Bitor, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_BITOR)
	globals.Operator(constants.OP_UI32_BITXOR, "ui32.bitxor", opUI32Bitxor, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_BITXOR)
	globals.Operator(constants.OP_UI32_BITCLEAR, "ui32.bitclear", opUI32Bitclear, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_BITCLEAR)
	globals.Operator(constants.OP_UI32_BITSHL, "ui32.bitshl", opUI32Bitshl, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_BITSHL)
	globals.Operator(constants.OP_UI32_BITSHR, "ui32.bitshr", opUI32Bitshr, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_BITSHR)
	globals.Operator(constants.OP_UI32_ADD, "ui32.add", opUI32Add, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_ADD)
	globals.Operator(constants.OP_UI32_SUB, "ui32.sub", opUI32Sub, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_SUB)
	globals.Operator(constants.OP_UI32_MUL, "ui32.mul", opUI32Mul, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_MUL)
	globals.Operator(constants.OP_UI32_DIV, "ui32.div", opUI32Div, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_DIV)
	globals.Operator(constants.OP_UI32_MOD, "ui32.mod", opUI32Mod, In(AUI32, AUI32), Out(AUI32), constants.TYPE_UI32, constants.OP_MOD)
	globals.Operator(constants.OP_UI32_GT, "ui32.gt", opUI32Gt, In(AUI32, AUI32), Out(ABOOL), constants.TYPE_UI32, constants.OP_GT)
	globals.Operator(constants.OP_UI32_GTEQ, "ui32.gteq", opUI32Gteq, In(AUI32, AUI32), Out(ABOOL), constants.TYPE_UI32, constants.OP_GTEQ)
	globals.Operator(constants.OP_UI32_LT, "ui32.lt", opUI32Lt, In(AUI32, AUI32), Out(ABOOL), constants.TYPE_UI32, constants.OP_LT)
	globals.Operator(constants.OP_UI32_LTEQ, "ui32.lteq", opUI32Lteq, In(AUI32, AUI32), Out(ABOOL), constants.TYPE_UI32, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_UI64_EQ, "ui64.eq", opUI64Eq, In(AUI64, AUI64), Out(ABOOL), constants.TYPE_UI64, constants.OP_EQUAL)
	globals.Operator(constants.OP_UI64_UNEQ, "ui64.uneq", opUI64Uneq, In(AUI64, AUI64), Out(ABOOL), constants.TYPE_UI64, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_UI64_BITAND, "ui64.bitand", opUI64Bitand, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_BITAND)
	globals.Operator(constants.OP_UI64_BITOR, "ui64.bitor", opUI64Bitor, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_BITOR)
	globals.Operator(constants.OP_UI64_BITXOR, "ui64.bitxor", opUI64Bitxor, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_BITXOR)
	globals.Operator(constants.OP_UI64_BITCLEAR, "ui64.bitclear", opUI64Bitclear, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_BITCLEAR)
	globals.Operator(constants.OP_UI64_BITSHL, "ui64.bitshl", opUI64Bitshl, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_BITSHL)
	globals.Operator(constants.OP_UI64_BITSHR, "ui64.bitshr", opUI64Bitshr, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_BITSHR)
	globals.Operator(constants.OP_UI64_ADD, "ui64.add", opUI64Add, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_ADD)
	globals.Operator(constants.OP_UI64_SUB, "ui64.sub", opUI64Sub, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_SUB)
	globals.Operator(constants.OP_UI64_MUL, "ui64.mul", opUI64Mul, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_MUL)
	globals.Operator(constants.OP_UI64_DIV, "ui64.div", opUI64Div, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_DIV)
	globals.Operator(constants.OP_UI64_MOD, "ui64.mod", opUI64Mod, In(AUI64, AUI64), Out(AUI64), constants.TYPE_UI64, constants.OP_MOD)
	globals.Operator(constants.OP_UI64_GT, "ui64.gt", opUI64Gt, In(AUI64, AUI64), Out(ABOOL), constants.TYPE_UI64, constants.OP_GT)
	globals.Operator(constants.OP_UI64_GTEQ, "ui64.gteq", opUI64Gteq, In(AUI64, AUI64), Out(ABOOL), constants.TYPE_UI64, constants.OP_GTEQ)
	globals.Operator(constants.OP_UI64_LT, "ui64.lt", opUI64Lt, In(AUI64, AUI64), Out(ABOOL), constants.TYPE_UI64, constants.OP_LT)
	globals.Operator(constants.OP_UI64_LTEQ, "ui64.lteq", opUI64Lteq, In(AUI64, AUI64), Out(ABOOL), constants.TYPE_UI64, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_F32_EQ, "f32.eq", opF32Eq, In(AF32, AF32), Out(ABOOL), constants.TYPE_F32, constants.OP_EQUAL)
	globals.Operator(constants.OP_F32_UNEQ, "f32.uneq", opF32Uneq, In(AF32, AF32), Out(ABOOL), constants.TYPE_F32, constants.OP_UNEQUAL)
	globals.Operator(constants.OP_F32_ADD, "f32.add", opF32Add, In(AF32, AF32), Out(AF32), constants.TYPE_F32, constants.OP_ADD)
	globals.Operator(constants.OP_F32_SUB, "f32.sub", opF32Sub, In(AF32, AF32), Out(AF32), constants.TYPE_F32, constants.OP_SUB)
	globals.Operator(constants.OP_F32_NEG, "f32.neg", opF32Neg, In(AF32), Out(AF32), constants.TYPE_F32, constants.OP_NEG)
	globals.Operator(constants.OP_F32_MUL, "f32.mul", opF32Mul, In(AF32, AF32), Out(AF32), constants.TYPE_F32, constants.OP_MUL)
	globals.Operator(constants.OP_F32_DIV, "f32.div", opF32Div, In(AF32, AF32), Out(AF32), constants.TYPE_F32, constants.OP_DIV)
	globals.Operator(constants.OP_F32_MOD, "f32.mod", opF32Mod, In(AF32, AF32), Out(AF32), constants.TYPE_F32, constants.OP_MOD)
    globals.Operator(constants.OP_F32_GT, "f32.gt", opF32Gt, In(AF32, AF32), Out(ABOOL), constants.TYPE_F32, constants.OP_GT)
	globals.Operator(constants.OP_F32_GTEQ, "f32.gteq", opF32Gteq, In(AF32, AF32), Out(ABOOL), constants.TYPE_F32, constants.OP_GTEQ)
	globals.Operator(constants.OP_F32_LT, "f32.lt", opF32Lt, In(AF32, AF32), Out(ABOOL), constants.TYPE_F32, constants.OP_LT)
	globals.Operator(constants.OP_F32_LTEQ, "f32.lteq", opF32Lteq, In(AF32, AF32), Out(ABOOL), constants.TYPE_F32, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_F64_EQ, "f64.eq", opF64Eq, In(AF64, AF64), Out(ABOOL), constants.TYPE_F64, constants.OP_EQUAL)
	globals.Operator(constants.OP_F64_UNEQ, "f64.uneq", opF64Uneq, In(AF64, AF64), Out(ABOOL), constants.TYPE_F64, constants.OP_UNEQUAL)
    globals.Operator(constants.OP_F64_ADD, "f64.add", opF64Add, In(AF64, AF64), Out(AF64), constants.TYPE_F64, constants.OP_ADD)
	globals.Operator(constants.OP_F64_SUB, "f64.sub", opF64Sub, In(AF64, AF64), Out(AF64), constants.TYPE_F64, constants.OP_SUB)
	globals.Operator(constants.OP_F64_NEG, "f64.neg", opF64Neg, In(AF64), Out(AF64), constants.TYPE_F64, constants.OP_NEG)
	globals.Operator(constants.OP_F64_MUL, "f64.mul", opF64Mul, In(AF64, AF64), Out(AF64), constants.TYPE_F64, constants.OP_MUL)
	globals.Operator(constants.OP_F64_DIV, "f64.div", opF64Div, In(AF64, AF64), Out(AF64), constants.TYPE_F64, constants.OP_DIV)
	globals.Operator(constants.OP_F64_MOD, "f32.mod", opF64Mod, In(AF64, AF64), Out(AF64), constants.TYPE_F64, constants.OP_MOD)
	globals.Operator(constants.OP_F64_GT, "f64.gt", opF64Gt, In(AF64, AF64), Out(ABOOL), constants.TYPE_F64, constants.OP_GT)
	globals.Operator(constants.OP_F64_GTEQ, "f64.gteq", opF64Gteq, In(AF64, AF64), Out(ABOOL), constants.TYPE_F64, constants.OP_GTEQ)
	globals.Operator(constants.OP_F64_LT, "f64.lt", opF64Lt, In(AF64, AF64), Out(ABOOL), constants.TYPE_F64, constants.OP_LT)
	globals.Operator(constants.OP_F64_LTEQ, "f64.lteq", opF64Lteq, In(AF64, AF64), Out(ABOOL), constants.TYPE_F64, constants.OP_LTEQ)
	...
	globals.Operator(constants.OP_STR_EQ, "str.eq", opStrEq, In(ASTR, ASTR), Out(ABOOL), constants.TYPE_STR, constants.OP_EQUAL)
	globals.Operator(constants.OP_STR_UNEQ, "str.uneq", opStrUneq, In(ASTR, ASTR), Out(ABOOL), constants.TYPE_STR, constants.OP_UNEQUAL)
    globals.Operator(constants.OP_STR_CONCAT, "str.concat", opStrConcat, In(ASTR, ASTR), Out(ASTR), constants.TYPE_STR, constants.OP_ADD)
