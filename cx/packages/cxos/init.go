...
func RegisterPackage() {
	...
	opcodes.RegisterFunction("os.ReadF64Slice", opOsReadF64Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.F64), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.F64), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadF32Slice", opOsReadF32Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.F32), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.F32), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadUI64Slice", opOsReadUI64Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI64), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.UI64), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadUI32Slice", opOsReadUI32Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI32), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.UI32), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadUI16Slice", opOsReadUI16Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI16), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.UI16), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadUI8Slice", opOsReadUI8Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI8), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.UI8), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadI64Slice", opOsReadI64Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I64), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.I64), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadI32Slice", opOsReadI32Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I32), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.I32), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadI16Slice", opOsReadI16Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I16), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.I16), ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.ReadI8Slice", opOsReadI8Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I8), ast.ConstCxArg_UI64), opcodes.Out(ast.Slice(types.I8), ast.ConstCxArg_BOOL))
	...
	opcodes.RegisterFunction("os.WriteF64Slice", opOsWriteF64Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.F64)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteF32Slice", opOsWriteF32Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.F32)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteUI64Slice", opOsWriteUI64Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI64)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteUI32Slice", opOsWriteUI32Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI32)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteUI16Slice", opOsWriteUI16Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI16)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteUI8Slice", opOsWriteUI8Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.UI8)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteI64Slice", opOsWriteI64Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I64)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteI32Slice", opOsWriteI32Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I32)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteI16Slice", opOsWriteI16Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I16)), opcodes.Out(ast.ConstCxArg_BOOL))
	opcodes.RegisterFunction("os.WriteI8Slice", opOsWriteI8Slice, opcodes.In(ast.ConstCxArg_I32, ast.Slice(types.I8)), opcodes.Out(ast.ConstCxArg_BOOL))
