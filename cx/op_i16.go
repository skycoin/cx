...
func opI16ToStr(inputs []CXValue, outputs []CXValue) {
...
func opI16ToI8(inputs []CXValue, outputs []CXValue) {
...
func opI16ToI32(inputs []CXValue, outputs []CXValue) {
...
func opI16ToI64(inputs []CXValue, outputs []CXValue) {
...
func opI16ToUI8(inputs []CXValue, outputs []CXValue) {
...
func opI16ToUI16(inputs []CXValue, outputs []CXValue) {
...
func opI16ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opI16ToUI64(inputs []CXValue, outputs []CXValue) {
...
func opI16ToF32(inputs []CXValue, outputs []CXValue) {
...
func opI16Gt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i16() > inputs[1].Get_i16()
...
// equal to operand 2.
func opI16Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i16() >= inputs[1].Get_i16()
	outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than operand 2.
func opI16Lt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i16() < inputs[1].Get_i16()
	outputs[0].Set_bool(outV0)
}
...
// to operand 1.
func opI16Lteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i16() <= inputs[1].Get_i16()
	outputs[0].Set_bool(outV0)
}

// The built-in eq function returns true if operand 1 is equal to operand 2.
func opI16Eq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i16() == inputs[1].Get_i16()
	outputs[0].Set_bool(outV0)
}

// The built-in uneq function returns true if operand 1 is different from operand 2.
func opI16Uneq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i16() != inputs[1].Get_i16()
	outputs[0].Set_bool(outV0)
}

// The built-in mod function returns the remainder of operand 1 / operand 2.
func opI16Mod(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i16() % inputs[1].Get_i16()
	outputs[0].Set_i16(outV0)
}

// The built-in rand function returns a pseudo random number in [operand 1, operand 2).
func opI16Rand(inputs []CXValue, outputs []CXValue) {
...
func opI16Bitshl(inputs []CXValue, outputs []CXValue) {
...
// by number of positions specified in operand 2.
func opI16Bitshr(inputs []CXValue, outputs []CXValue) {
	outV0 := int16(inputs[0].Get_i16() >> uint16(inputs[1].Get_i16()))
	outputs[0].Set_i16(outV0)
}

// The built-in max function returns the biggest of the two operands.
func opI16Max(inputs []CXValue, outputs []CXValue) {
...
func opI16Min(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_i16()
	inpV1 := inputs[1].Get_i16()
	if inpV1 < inpV0 {
		inpV0 = inpV1
