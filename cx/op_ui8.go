...
func opUI8ToStr(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToI8(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToI16(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToI32(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToI64(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToUI16(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToUI64(inputs []CXValue, outputs []CXValue) {
...
func opUI8ToF32(inputs []CXValue, outputs []CXValue) {
...
func opUI8Sub(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui8() - inputs[1].Get_ui8()
	outputs[0].Set_ui8(outV0)
}

// The built-in mul function returns the product of two ui8 numbers.
func opUI8Mul(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui8() * inputs[1].Get_ui8()
	outputs[0].Set_ui8(outV0)
}

// The built-in div function returns the quotient of two ui8 numbers.
func opUI8Div(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui8() / inputs[1].Get_ui8()
	outputs[0].Set_ui8(outV0)
}

// The built-in gt function returns true if operand 1 is greater than operand 2.
func opUI8Gt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui8() > inputs[1].Get_ui8()
...
// equal to operand 2.
func opUI8Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui8() >= inputs[1].Get_ui8()
	outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than operand 2.
func opUI8Lt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui8() < inputs[1].Get_ui8()
	outputs[0].Set_bool(outV0)
}
...
func opUI8Bitshl(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui8() << inputs[1].Get_ui8()
	outputs[0].Set_ui8(outV0)
}
...
func opUI8Min(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_ui8()
	inpV1 := inputs[1].Get_ui8()
	if inpV1 < inpV0 {
		inpV0 = inpV1
