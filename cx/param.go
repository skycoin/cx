...
func init() {
	...
	ast.Op_V2(constants.OP_LT, "lt", nil, In(AUND, AUND), Out(ABOOL))
	ast.Op_V2(constants.OP_GT, "gt", nil, In(AUND, AUND), Out(ABOOL))
	...
	ast.Op_V2(constants.OP_BOOL_NOT, "bool.not", opBoolNot, In(ABOOL), Out(ABOOL))
	ast.Op_V2(constants.OP_BOOL_OR, "bool.or", opBoolOr, In(ABOOL, ABOOL), Out(ABOOL))
	ast.Op_V2(constants.OP_BOOL_AND, "bool.and", opBoolAnd, In(ABOOL, ABOOL), Out(ABOOL))
	...
	ast.Op_V2(constants.OP_I8_STR, "i8.str", opI8ToStr, In(AI8), Out(ASTR))
	ast.Op_V2(constants.OP_I8_I16, "i8.i16", opI8ToI16, In(AI8), Out(AI16))
	ast.Op_V2(constants.OP_I8_I32, "i8.i32", opI8ToI32, In(AI8), Out(AI32))
	ast.Op_V2(constants.OP_I8_I64, "i8.i64", opI8ToI64, In(AI8), Out(AI64))
	ast.Op_V2(constants.OP_I8_UI8, "i8.ui8", opI8ToUI8, In(AI8), Out(AUI8))
	ast.Op_V2(constants.OP_I8_UI16, "i8.ui16", opI8ToUI16, In(AI8), Out(AUI16))
	ast.Op_V2(constants.OP_I8_UI32, "i8.ui32", opI8ToUI32, In(AI8), Out(AUI32))
	ast.Op_V2(constants.OP_I8_UI64, "i8.ui64", opI8ToUI64, In(AI8), Out(AUI64))
	ast.Op_V2(constants.OP_I8_F32, "i8.f32", opI8ToF32, In(AI8), Out(AF32))
	ast.Op_V2(constants.OP_I8_F64, "i8.f64", opI8ToF64, In(AI8), Out(AF64))
	ast.Op_V2(constants.OP_I8_PRINT, "i8.print", opI8Print, In(AI8), nil)
	ast.Op_V2(constants.OP_I8_ABS, "i8.abs", opI8Abs, In(AI8), Out(AI8))
	ast.Op_V2(constants.OP_I8_MAX, "i8.max", opI8Max, In(AI8, AI8), Out(AI8))
	ast.Op_V2(constants.OP_I8_MIN, "i8.min", opI8Min, In(AI8, AI8), Out(AI8))
	ast.Op_V2(constants.OP_I8_RAND, "i8.rand", opI8Rand, In(AI8, AI8), Out(AI8))
	...
	ast.Op_V2(constants.OP_I16_STR, "i16.str", opI16ToStr, In(AI16), Out(ASTR))
	ast.Op_V2(constants.OP_I16_I8, "i16.i8", opI16ToI8, In(AI16), Out(AI8))
	ast.Op_V2(constants.OP_I16_I32, "i16.i32", opI16ToI32, In(AI16), Out(AI32))
	ast.Op_V2(constants.OP_I16_I64, "i16.i64", opI16ToI64, In(AI16), Out(AI64))
	ast.Op_V2(constants.OP_I16_UI8, "i16.ui8", opI16ToUI8, In(AI16), Out(AUI8))
	ast.Op_V2(constants.OP_I16_UI16, "i16.ui16", opI16ToUI16, In(AI16), Out(AUI16))
	ast.Op_V2(constants.OP_I16_UI32, "i16.ui32", opI16ToUI32, In(AI16), Out(AUI32))
	ast.Op_V2(constants.OP_I16_UI64, "i16.ui64", opI16ToUI64, In(AI16), Out(AUI64))
	ast.Op_V2(constants.OP_I16_F32, "i16.f32", opI16ToF32, In(AI16), Out(AF32))
	ast.Op_V2(constants.OP_I16_F64, "i16.f64", opI16ToF64, In(AI16), Out(AF64))
	ast.Op_V2(constants.OP_I16_PRINT, "i16.print", opI16Print, In(AI16), nil)
	ast.Op_V2(constants.OP_I16_ABS, "i16.abs", opI16Abs, In(AI16), Out(AI16))
	ast.Op_V2(constants.OP_I16_MAX, "i16.max", opI16Max, In(AI16, AI16), Out(AI16))
	ast.Op_V2(constants.OP_I16_MIN, "i16.min", opI16Min, In(AI16, AI16), Out(AI16))
	ast.Op_V2(constants.OP_I16_RAND, "i16.rand", opI16Rand, In(AI16, AI16), Out(AI16))
	...
	ast.Op_V2(constants.OP_I32_STR, "i32.str", opI32ToStr, In(AI32), Out(ASTR))
	ast.Op_V2(constants.OP_I32_I8, "i32.i8", opI32ToI8, In(AI32), Out(AI8))
	ast.Op_V2(constants.OP_I32_I16, "i32.i16", opI32ToI16, In(AI32), Out(AI16))
	ast.Op_V2(constants.OP_I32_I64, "i32.i64", opI32ToI64, In(AI32), Out(AI64))
	ast.Op_V2(constants.OP_I32_UI8, "i32.ui8", opI32ToUI8, In(AI32), Out(AUI8))
	ast.Op_V2(constants.OP_I32_UI16, "i32.ui16", opI32ToUI16, In(AI32), Out(AUI16))
	ast.Op_V2(constants.OP_I32_UI32, "i32.ui32", opI32ToUI32, In(AI32), Out(AUI32))
	ast.Op_V2(constants.OP_I32_UI64, "i32.ui64", opI32ToUI64, In(AI32), Out(AUI64))
	ast.Op_V2(constants.OP_I32_F32, "i32.f32", opI32ToF32, In(AI32), Out(AF32))
	ast.Op_V2(constants.OP_I32_F64, "i32.f64", opI32ToF64, In(AI32), Out(AF64))
	ast.Op_V2(constants.OP_I32_PRINT, "i32.print", opI32Print, In(AI32), nil)
	ast.Op_V2(constants.OP_I32_ABS, "i32.abs", opI32Abs, In(AI32), Out(AI32))
	ast.Op_V2(constants.OP_I32_MAX, "i32.max", opI32Max, In(AI32, AI32), Out(AI32))
	ast.Op_V2(constants.OP_I32_MIN, "i32.min", opI32Min, In(AI32, AI32), Out(AI32))
	ast.Op_V2(constants.OP_I32_RAND, "i32.rand", opI32Rand, In(AI32, AI32), Out(AI32))
	...
	ast.Op_V2(constants.OP_I64_STR, "i64.str", opI64ToStr, In(AI64), Out(ASTR))
	ast.Op_V2(constants.OP_I64_I8, "i64.i8", opI64ToI8, In(AI64), Out(AI8))
	ast.Op_V2(constants.OP_I64_I16, "i64.i16", opI64ToI16, In(AI64), Out(AI16))
	ast.Op_V2(constants.OP_I64_I32, "i64.i32", opI64ToI32, In(AI64), Out(AI32))
	ast.Op_V2(constants.OP_I64_UI8, "i64.ui8", opI64ToUI8, In(AI64), Out(AUI8))
	ast.Op_V2(constants.OP_I64_UI16, "i64.ui16", opI64ToUI16, In(AI64), Out(AUI16))
	ast.Op_V2(constants.OP_I64_UI32, "i64.ui32", opI64ToUI32, In(AI64), Out(AUI32))
	ast.Op_V2(constants.OP_I64_UI64, "i64.ui64", opI64ToUI64, In(AI64), Out(AUI64))
	ast.Op_V2(constants.OP_I64_F32, "i64.f32", opI64ToF32, In(AI64), Out(AF32))
	ast.Op_V2(constants.OP_I64_F64, "i64.f64", opI64ToF64, In(AI64), Out(AF64))
	ast.Op_V2(constants.OP_I64_PRINT, "i64.print", opI64Print, In(AI64), nil)
	ast.Op_V2(constants.OP_I64_ABS, "i64.abs", opI64Abs, In(AI64), Out(AI64))
	ast.Op_V2(constants.OP_I64_MAX, "i64.max", opI64Max, In(AI64, AI64), Out(AI64))
	ast.Op_V2(constants.OP_I64_MIN, "i64.min", opI64Min, In(AI64, AI64), Out(AI64))
	ast.Op_V2(constants.OP_I64_RAND, "i64.rand", opI64Rand, In(AI64, AI64), Out(AI64))
	...
	ast.Op_V2(constants.OP_UI8_STR, "ui8.str", opUI8ToStr, In(AUI8), Out(ASTR))
	ast.Op_V2(constants.OP_UI8_I8, "ui8.i8", opUI8ToI8, In(AUI8), Out(AI8))
	ast.Op_V2(constants.OP_UI8_I16, "ui8.i16", opUI8ToI16, In(AUI8), Out(AI16))
	ast.Op_V2(constants.OP_UI8_I32, "ui8.i32", opUI8ToI32, In(AUI8), Out(AI32))
	ast.Op_V2(constants.OP_UI8_I64, "ui8.i64", opUI8ToI64, In(AUI8), Out(AI64))
	ast.Op_V2(constants.OP_UI8_UI16, "ui8.ui16", opUI8ToUI16, In(AUI8), Out(AUI16))
	ast.Op_V2(constants.OP_UI8_UI32, "ui8.ui32", opUI8ToUI32, In(AUI8), Out(AUI32))
	ast.Op_V2(constants.OP_UI8_UI64, "ui8.ui64", opUI8ToUI64, In(AUI8), Out(AUI64))
	ast.Op_V2(constants.OP_UI8_F32, "ui8.f32", opUI8ToF32, In(AUI8), Out(AF32))
	ast.Op_V2(constants.OP_UI8_F64, "ui8.f64", opUI8ToF64, In(AUI8), Out(AF64))
	ast.Op_V2(constants.OP_UI8_PRINT, "ui8.print", opUI8Print, In(AUI8), nil)
	ast.Op_V2(constants.OP_UI8_MAX, "ui8.max", opUI8Max, In(AUI8, AUI8), Out(AUI8))
	ast.Op_V2(constants.OP_UI8_MIN, "ui8.min", opUI8Min, In(AUI8, AUI8), Out(AUI8))
	ast.Op_V2(constants.OP_UI8_RAND, "ui8.rand", opUI8Rand, nil, Out(AUI8))
	...
	ast.Op_V2(constants.OP_UI16_STR, "ui16.str", opUI16ToStr, In(AUI16), Out(ASTR))
	ast.Op_V2(constants.OP_UI16_I8, "ui16.i8", opUI16ToI8, In(AUI16), Out(AI8))
	ast.Op_V2(constants.OP_UI16_I16, "ui16.i16", opUI16ToI16, In(AUI16), Out(AI16))
	ast.Op_V2(constants.OP_UI16_I32, "ui16.i32", opUI16ToI32, In(AUI16), Out(AI32))
	ast.Op_V2(constants.OP_UI16_I64, "ui16.i64", opUI16ToI64, In(AUI16), Out(AI64))
	ast.Op_V2(constants.OP_UI16_UI8, "ui16.ui8", opUI16ToUI8, In(AUI16), Out(AUI8))
	ast.Op_V2(constants.OP_UI16_UI32, "ui16.ui32", opUI16ToUI32, In(AUI16), Out(AUI32))
	ast.Op_V2(constants.OP_UI16_UI64, "ui16.ui64", opUI16ToUI64, In(AUI16), Out(AUI64))
	ast.Op_V2(constants.OP_UI16_F32, "ui16.f32", opUI16ToF32, In(AUI16), Out(AF32))
	ast.Op_V2(constants.OP_UI16_F64, "ui16.f64", opUI16ToF64, In(AUI16), Out(AF64))
	ast.Op_V2(constants.OP_UI16_PRINT, "ui16.print", opUI16Print, In(AUI16), nil)
	ast.Op_V2(constants.OP_UI16_MAX, "ui16.max", opUI16Max, In(AUI16, AUI16), Out(AUI16))
	ast.Op_V2(constants.OP_UI16_MIN, "ui16.min", opUI16Min, In(AUI16, AUI16), Out(AUI16))
	ast.Op_V2(constants.OP_UI16_RAND, "ui16.rand", opUI16Rand, nil, Out(AUI16))
	...
	ast.Op_V2(constants.OP_UI32_STR, "ui32.str", opUI32ToStr, In(AUI32), Out(ASTR))
	ast.Op_V2(constants.OP_UI32_I8, "ui32.i8", opUI32ToI8, In(AUI32), Out(AI8))
	ast.Op_V2(constants.OP_UI32_I16, "ui32.i16", opUI32ToI16, In(AUI32), Out(AI16))
	ast.Op_V2(constants.OP_UI32_I32, "ui32.i32", opUI32ToI32, In(AUI32), Out(AI32))
	ast.Op_V2(constants.OP_UI32_I64, "ui32.i64", opUI32ToI64, In(AUI32), Out(AI64))
	ast.Op_V2(constants.OP_UI32_UI8, "ui32.ui8", opUI32ToUI8, In(AUI32), Out(AUI8))
	ast.Op_V2(constants.OP_UI32_UI16, "ui32.ui16", opUI32ToUI16, In(AUI32), Out(AUI16))
	ast.Op_V2(constants.OP_UI32_UI64, "ui32.ui64", opUI32ToUI64, In(AUI32), Out(AUI64))
	ast.Op_V2(constants.OP_UI32_F32, "ui32.f32", opUI32ToF32, In(AUI32), Out(AF32))
	ast.Op_V2(constants.OP_UI32_F64, "ui32.f64", opUI32ToF64, In(AUI32), Out(AF64))
	ast.Op_V2(constants.OP_UI32_PRINT, "ui32.print", opUI32Print, In(AUI32), nil)
	ast.Op_V2(constants.OP_UI32_MAX, "ui32.max", opUI32Max, In(AUI32, AUI32), Out(AUI32))
	ast.Op_V2(constants.OP_UI32_MIN, "ui32.min", opUI32Min, In(AUI32, AUI32), Out(AUI32))
	ast.Op_V2(constants.OP_UI32_RAND, "ui32.rand", opUI32Rand, nil, Out(AUI32))
	...
	ast.Op_V2(constants.OP_UI64_STR, "ui64.str", opUI64ToStr, In(AUI64), Out(ASTR))
	ast.Op_V2(constants.OP_UI64_I8, "ui64.i8", opUI64ToI8, In(AUI64), Out(AI8))
	ast.Op_V2(constants.OP_UI64_I16, "ui64.i16", opUI64ToI16, In(AUI64), Out(AI16))
	ast.Op_V2(constants.OP_UI64_I32, "ui64.i32", opUI64ToI32, In(AUI64), Out(AI32))
	ast.Op_V2(constants.OP_UI64_I64, "ui64.i64", opUI64ToI64, In(AUI64), Out(AI64))
	ast.Op_V2(constants.OP_UI64_UI8, "ui64.ui8", opUI64ToUI8, In(AUI64), Out(AUI8))
	ast.Op_V2(constants.OP_UI64_UI16, "ui64.ui16", opUI64ToUI16, In(AUI64), Out(AUI16))
	ast.Op_V2(constants.OP_UI64_UI32, "ui64.ui32", opUI64ToUI32, In(AUI64), Out(AUI32))
	ast.Op_V2(constants.OP_UI64_F32, "ui64.f32", opUI64ToF32, In(AUI64), Out(AF32))
	ast.Op_V2(constants.OP_UI64_F64, "ui64.f64", opUI64ToF64, In(AUI64), Out(AF64))
	ast.Op_V2(constants.OP_UI64_PRINT, "ui64.print", opUI64Print, In(AUI64), nil)
	ast.Op_V2(constants.OP_UI64_MAX, "ui64.max", opUI64Max, In(AUI64, AUI64), Out(AUI64))
	ast.Op_V2(constants.OP_UI64_MIN, "ui64.min", opUI64Min, In(AUI64, AUI64), Out(AUI64))
	ast.Op_V2(constants.OP_UI64_RAND, "ui64.rand", opUI64Rand, nil, Out(AUI64))
	...
	ast.Op_V2(constants.OP_F32_IS_NAN, "f32.isnan", opF32Isnan, In(AF32), Out(ABOOL))
	ast.Op_V2(constants.OP_F32_STR, "f32.str", opF32ToStr, In(AF32), Out(ASTR))
	ast.Op_V2(constants.OP_F32_I8, "f32.i8", opF32ToI8, In(AF32), Out(AI8))
	ast.Op_V2(constants.OP_F32_I16, "f32.i16", opF32ToI16, In(AF32), Out(AI16))
	ast.Op_V2(constants.OP_F32_I32, "f32.i32", opF32ToI32, In(AF32), Out(AI32))
	ast.Op_V2(constants.OP_F32_I64, "f32.i64", opF32ToI64, In(AF32), Out(AI64))
	ast.Op_V2(constants.OP_F32_UI8, "f32.ui8", opF32ToUI8, In(AF32), Out(AUI8))
	ast.Op_V2(constants.OP_F32_UI16, "f32.ui16", opF32ToUI16, In(AF32), Out(AUI16))
	ast.Op_V2(constants.OP_F32_UI32, "f32.ui32", opF32ToUI32, In(AF32), Out(AUI32))
	ast.Op_V2(constants.OP_F32_UI64, "f32.ui64", opF32ToUI64, In(AF32), Out(AUI64))
	ast.Op_V2(constants.OP_F32_F64, "f32.f64", opF32ToF64, In(AF32), Out(AF64))
	ast.Op_V2(constants.OP_F32_PRINT, "f32.print", opF32Print, In(AF32), nil)
	ast.Op_V2(constants.OP_F32_ABS, "f32.abs", opF32Abs, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_POW, "f32.pow", opF32Pow, In(AF32, AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_ACOS, "f32.acos", opF32Acos, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_COS, "f32.cos", opF32Cos, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_ASIN, "f32.asin", opF32Asin, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_SIN, "f32.sin", opF32Sin, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_SQRT, "f32.sqrt", opF32Sqrt, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_LOG, "f32.log", opF32Log, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_LOG2, "f32.log2", opF32Log2, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_LOG10, "f32.log10", opF32Log10, In(AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_MAX, "f32.max", opF32Max, In(AF32, AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_MIN, "f32.min", opF32Min, In(AF32, AF32), Out(AF32))
	ast.Op_V2(constants.OP_F32_RAND, "f32.rand", opF32Rand, nil, Out(AF32))
	...
	ast.Op_V2(constants.OP_F64_IS_NAN, "f64.isnan", opF64Isnan, In(AF64), Out(ABOOL))
	ast.Op_V2(constants.OP_F64_STR, "f64.str", opF64ToStr, In(AF64), Out(ASTR))
	ast.Op_V2(constants.OP_F64_I8, "f64.i8", opF64ToI8, In(AF64), Out(AI8))
	ast.Op_V2(constants.OP_F64_I16, "f64.i16", opF64ToI16, In(AF64), Out(AI16))
	ast.Op_V2(constants.OP_F64_I32, "f64.i32", opF64ToI32, In(AF64), Out(AI32))
	ast.Op_V2(constants.OP_F64_I64, "f64.i64", opF64ToI64, In(AF64), Out(AI64))
	ast.Op_V2(constants.OP_F64_UI8, "f64.ui8", opF64ToUI8, In(AF64), Out(AUI8))
	ast.Op_V2(constants.OP_F64_UI16, "f64.ui16", opF64ToUI16, In(AF64), Out(AUI16))
	ast.Op_V2(constants.OP_F64_UI32, "f64.ui32", opF64ToUI32, In(AF64), Out(AUI32))
	ast.Op_V2(constants.OP_F64_UI64, "f64.ui64", opF64ToUI64, In(AF64), Out(AUI64))
	ast.Op_V2(constants.OP_F64_F32, "f64.f32", opF64ToF32, In(AF64), Out(AF32))
	ast.Op_V2(constants.OP_F64_PRINT, "f64.print", opF64Print, In(AF64), nil)
	ast.Op_V2(constants.OP_F64_ABS, "f64.abs", opF64Abs, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_POW, "f64.pow", opF64Pow, In(AF64, AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_ACOS, "f64.acos", opF64Acos, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_COS, "f64.cos", opF64Cos, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_ASIN, "f64.asin", opF64Asin, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_SIN, "f64.sin", opF64Sin, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_SQRT, "f64.sqrt", opF64Sqrt, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_LOG, "f64.log", opF64Log, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_LOG2, "f64.log2", opF64Log2, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_LOG10, "f64.log10", opF64Log10, In(AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_MAX, "f64.max", opF64Max, In(AF64, AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_MIN, "f64.min", opF64Min, In(AF64, AF64), Out(AF64))
	ast.Op_V2(constants.OP_F64_RAND, "f64.rand", opF64Rand, nil, Out(AF64))
	...
	ast.Op_V2(constants.OP_STR_I8, "str.i8", opStrToI8, In(ASTR), Out(AI8))
	ast.Op_V2(constants.OP_STR_I16, "str.i16", opStrToI16, In(ASTR), Out(AI16))
	ast.Op_V2(constants.OP_STR_I32, "str.i32", opStrToI32, In(ASTR), Out(AI32))
	ast.Op_V2(constants.OP_STR_I64, "str.i64", opStrToI64, In(ASTR), Out(AI64))
	ast.Op_V2(constants.OP_STR_UI8, "str.ui8", opStrToUI8, In(ASTR), Out(AUI8))
	ast.Op_V2(constants.OP_STR_UI16, "str.ui16", opStrToUI16, In(ASTR), Out(AUI16))
	ast.Op_V2(constants.OP_STR_UI32, "str.ui32", opStrToUI32, In(ASTR), Out(AUI32))
	ast.Op_V2(constants.OP_STR_UI64, "str.ui64", opStrToUI64, In(ASTR), Out(AUI64))
	ast.Op_V2(constants.OP_STR_F32, "str.f32", opStrToF32, In(ASTR), Out(AF32))
	ast.Op_V2(constants.OP_STR_F64, "str.f64", opStrToF64, In(ASTR), Out(AF64))
	ast.Op_V2(constants.OP_STR_PRINT, "str.print", opStrPrint, In(ASTR), nil)
	ast.Op_V2(constants.OP_STR_SUBSTR, "str.substr", opStrSubstr, In(ASTR, AI32, AI32), Out(ASTR))
	ast.Op_V2(constants.OP_STR_INDEX, "str.index", opStrIndex, In(ASTR, ASTR), Out(AI32))
