...
func opI64ToStr(inputs []CXValue, outputs []CXValue) {
...
func opI64ToI8(inputs []CXValue, outputs []CXValue) {
...
func opI64ToI16(inputs []CXValue, outputs []CXValue) {
...
func opI64ToI32(inputs []CXValue, outputs []CXValue) {
...
func opI64ToUI8(inputs []CXValue, outputs []CXValue) {
...
func opI64ToUI16(inputs []CXValue, outputs []CXValue) {
...
func opI64ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opI64ToUI64(inputs []CXValue, outputs []CXValue) {
...
func opI64ToF32(inputs []CXValue, outputs []CXValue) {
...
func opI64Gt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i64() > inputs[1].Get_i64()
...
// equal to operand 2.
func opI64Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i64() >= inputs[1].Get_i64()
	outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than oeprand 2.
func opI64Lt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i64() < inputs[1].Get_i64()
	outputs[0].Set_bool(outV0)
}
...
// equal to operand 2.
func opI64Lteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i64() <= inputs[1].Get_i64()
	outputs[0].Set_bool(outV0)
}

// The built-in eq function returns true if operand 1 is equal to operand 2.
func opI64Eq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i64() == inputs[1].Get_i64()
	outputs[0].Set_bool(outV0)
}

// The built-in uneq function returns true if operand 1 is different from operand 2.
func opI64Uneq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i64() != inputs[1].Get_i64()
	outputs[0].Set_bool(outV0)
}

// The built-in mod function returns the remainder of operand 1 divided by operand 2.
func opI64Mod(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_i64() % inputs[1].Get_i64()
	outputs[0].Set_i64(outV0)
}

// The built-in rand function returns a pseudo random number in [operand 1, operand 2).
func opI64Rand(inputs []CXValue, outputs []CXValue) {
...
func opI64Bitshl(inputs []CXValue, outputs []CXValue) {
...
// by number of positions specified in operand 2.
func opI64Bitshr(inputs []CXValue, outputs []CXValue) {
	outV0 := int64(inputs[0].Get_i64() >> uint64(inputs[1].Get_i64()))
	outputs[0].Set_i64(outV0)
}

// The built-in max function returns the greatest value of the two operands.
func opI64Max(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_i64()
...
func opI64Min(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_i64()
	inpV1 := inputs[1].Get_i64()
	if inpV1 < inpV0 {
		inpV0 = inpV1
