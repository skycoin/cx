...
func opF32ToStr(inputs []CXValue, outputs []CXValue) {
...
func opF32ToI8(inputs []CXValue, outputs []CXValue) {
...
func opF32ToI16(inputs []CXValue, outputs []CXValue) {
...
func opF32ToI32(inputs []CXValue, outputs []CXValue) {
...
func opF32ToI64(inputs []CXValue, outputs []CXValue) {
...
func opF32ToUI8(inputs []CXValue, outputs []CXValue) {
...
func opF32ToUI16(inputs []CXValue, outputs []CXValue) {
...
func opF32ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opF32ToUI64(inputs []CXValue, outputs []CXValue) {
...
// equal to operand 2.
func opF32Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_f32() >= inputs[1].Get_f32()
	outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than operand 2.
func opF32Lt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_f32() < inputs[1].Get_f32()
	outputs[0].Set_bool(outV0)
}
...
func opF32Min(inputs []CXValue, outputs []CXValue) {
