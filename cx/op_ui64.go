...
func opUI64ToStr(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToI8(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToI16(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToI32(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToI64(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToUI8(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToUI16(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opUI64ToF32(inputs []CXValue, outputs []CXValue) {
...
func opUI64Sub(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() - inputs[1].Get_ui64()
	outputs[0].Set_ui64(outV0)
}

// The built-in mul function returns the product of two ui64 numbers.
func opUI64Mul(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() * inputs[1].Get_ui64()
	outputs[0].Set_ui64(outV0)
}

// The built-in div function returns the quotient of two ui64 numbers.
func opUI64Div(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() / inputs[1].Get_ui64()
	outputs[0].Set_ui64(outV0)
}

// The built-in gt function returns true if operand 1 is greater than operand 2.
func opUI64Gt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() > inputs[1].Get_ui64()
...
// equal to operand 2.
func opUI64Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() >= inputs[1].Get_ui64()
	outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than operand 2.
func opUI64Lt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() < inputs[1].Get_ui64()
	outputs[0].Set_bool(outV0)
}
...
func opUI64Bitshl(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() << inputs[1].Get_ui64()
	outputs[0].Set_ui64(outV0)
}
...
// by number of positions specified in operand 2.
func opUI64Bitshr(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui64() >> inputs[1].Get_ui64()
	outputs[0].Set_ui64(outV0)
}

// The built-in max function returns the biggest of the two operands.
func opUI64Max(inputs []CXValue, outputs []CXValue) {
...
func opUI64Min(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_ui64()
	inpV1 := inputs[1].Get_ui64()
	if inpV1 < inpV0 {
		inpV0 = inpV1
