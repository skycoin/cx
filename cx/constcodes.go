...
const (
	...
	CONST_CX_STACK_OVERFLOW_ERROR
	CONST_CX_HEAP_EXHAUSTED_ERROR
...
func init() {
	...
	AddConstCode( CONST_CX_STACK_OVERFLOW_ERROR        , "cx.STACK_OVERFLOW_ERROR"       , TYPE_I32, FromI32(CONST_CX_STACK_OVERFLOW_ERROR))
	AddConstCode( CONST_CX_HEAP_EXHAUSTED_ERROR        , "cx.HEAP_EXHAUSTED_ERROR"       , TYPE_I32, FromI32(CONST_CX_HEAP_EXHAUSTED_ERROR))
