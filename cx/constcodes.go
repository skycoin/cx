...
func init() {
	...
	AddConstCode(CONST_GL_CW, "gl.CW", TYPE_I32, FromI32(0x0900))
	AddConstCode(CONST_GL_CCW, "gl.CCW", TYPE_I32, FromI32(0x0901))
	...
	AddConstCode(CONST_GL_CULL_FACE_MODE, "gl.CULL_FACE_MODE", TYPE_I32, FromI32(0x0B45))
	AddConstCode(CONST_GL_FRONT_FACE, "gl.FRONT_FACE", TYPE_I32, FromI32(0x0B46))
	...
	AddConstCode(CONST_GL_BYTE, "gl.BYTE", TYPE_I32, FromI32(0x1400))
	AddConstCode(CONST_GL_UNSIGNED_BYTE, "gl.UNSIGNED_BYTE", TYPE_I32, FromI32(0x1401))
	AddConstCode(CONST_GL_SHORT, "gl.SHORT", TYPE_I32, FromI32(0x1402))
	AddConstCode(CONST_GL_UNSIGNED_SHORT, "gl.UNSIGNED_SHORT", TYPE_I32, FromI32(0x1403))
	AddConstCode(CONST_GL_INT, "gl.INT", TYPE_I32, FromI32(0x1404))
	AddConstCode(CONST_GL_UNSIGNED_INT, "gl.UNSIGNED_INT", TYPE_I32, FromI32(0x1405))
	...
	AddConstCode(CONST_GL_TEXTURE_CUBE_MAP, "gl.TEXTURE_CUBE_MAP", TYPE_I32, FromI32(0x8513))
	AddConstCode(CONST_GL_TEXTURE_CUBE_MAP_POSITIVE_X, "gl.TEXTURE_CUBE_MAP_POSITIVE_X", TYPE_I32, FromI32(0x8515))
	AddConstCode(CONST_GL_TEXTURE_CUBE_MAP_NEGATIVE_X, "gl.TEXTURE_CUBE_MAP_NEGATIVE_X", TYPE_I32, FromI32(0x8516))
	AddConstCode(CONST_GL_TEXTURE_CUBE_MAP_POSITIVE_Y, "gl.TEXTURE_CUBE_MAP_POSITIVE_Y", TYPE_I32, FromI32(0x8517))
	AddConstCode(CONST_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y, "gl.TEXTURE_CUBE_MAP_NEGATIVE_Y", TYPE_I32, FromI32(0x8518))
	AddConstCode(CONST_GL_TEXTURE_CUBE_MAP_POSITIVE_Z, "gl.TEXTURE_CUBE_MAP_POSITIVE_Z", TYPE_I32, FromI32(0x8519))
	AddConstCode(CONST_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z, "gl.TEXTURE_CUBE_MAP_NEGATIVE_Z", TYPE_I32, FromI32(0x851A))
	...
	AddConstCode(CONST_GL_ELEMENT_ARRAY_BUFFER, "gl.ELEMENT_ARRAY_BUFFER", TYPE_I32, FromI32(0x8893))
