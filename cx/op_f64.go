...
func opF64ToStr(inputs []CXValue, outputs []CXValue) {
...
func opF64ToI8(inputs []CXValue, outputs []CXValue) {
...
func opF64ToI16(inputs []CXValue, outputs []CXValue) {
...
func opF64ToI32(inputs []CXValue, outputs []CXValue) {
...
func opF64ToI64(inputs []CXValue, outputs []CXValue) {
...
func opF64ToUI8(inputs []CXValue, outputs []CXValue) {
...
func opF64ToUI16(inputs []CXValue, outputs []CXValue) {
...
func opF64ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opF64ToUI64(inputs []CXValue, outputs []CXValue) {
...
func opF64Gt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_f64() > inputs[1].Get_f64()
	outputs[0].Set_bool(outV0)
}
...
// equal to operand 2.
func opF64Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_f64() >= inputs[1].Get_f64()
	outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than operand 2.
func opF64Lt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_f64() < inputs[1].Get_f64()
	outputs[0].Set_bool(outV0)
}
