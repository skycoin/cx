...
func init() {
	...
	Op(OP_OS_CREATE, "os.Create", opOsCreate, In(ASTR), Out(AI32))
	...
	Op(OP_OS_READ_BOOL, "os.ReadBOOL", opOsReadBOOL, In(AI32), Out(ABOOL, ABOOL))
	Op(OP_OS_READ_F64_SLICE, "os.ReadF64Slice", opOsReadF64Slice, In(AI32, Slice(TYPE_F64), AUI64), Out(Slice(TYPE_F64), ABOOL))
	Op(OP_OS_READ_F32_SLICE, "os.ReadF32Slice", opOsReadF32Slice, In(AI32, Slice(TYPE_F32), AUI64), Out(Slice(TYPE_F32), ABOOL))
	Op(OP_OS_READ_UI64_SLICE, "os.ReadUI64Slice", opOsReadUI64Slice, In(AI32, Slice(TYPE_UI64), AUI64), Out(Slice(TYPE_UI64), ABOOL))
	Op(OP_OS_READ_UI32_SLICE, "os.ReadUI32Slice", opOsReadUI32Slice, In(AI32, Slice(TYPE_UI32), AUI64), Out(Slice(TYPE_UI32), ABOOL))
	Op(OP_OS_READ_UI16_SLICE, "os.ReadUI16Slice", opOsReadUI16Slice, In(AI32, Slice(TYPE_UI16), AUI64), Out(Slice(TYPE_UI16), ABOOL))
	Op(OP_OS_READ_UI8_SLICE, "os.ReadUI8Slice", opOsReadUI8Slice, In(AI32, Slice(TYPE_UI8), AUI64), Out(Slice(TYPE_UI8), ABOOL))
	Op(OP_OS_READ_I64_SLICE, "os.ReadI64Slice", opOsReadI64Slice, In(AI32, Slice(TYPE_I64), AUI64), Out(Slice(TYPE_I64), ABOOL))
	Op(OP_OS_READ_I32_SLICE, "os.ReadI32Slice", opOsReadI32Slice, In(AI32, Slice(TYPE_I32), AUI64), Out(Slice(TYPE_I32), ABOOL))
	Op(OP_OS_READ_I16_SLICE, "os.ReadI16Slice", opOsReadI16Slice, In(AI32, Slice(TYPE_I16), AUI64), Out(Slice(TYPE_I16), ABOOL))
	Op(OP_OS_READ_I8_SLICE, "os.ReadI8Slice", opOsReadI8Slice, In(AI32, Slice(TYPE_I8), AUI64), Out(Slice(TYPE_I8), ABOOL))
	Op(OP_OS_READ_ALL_TEXT, "os.ReadAllText", opOsReadAllText, In(ASTR), Out(ASTR, ABOOL))
	Op(OP_OS_WRITE_STR, "os.WriteStr", opOsWriteStr, In(AI32, ASTR), Out(ABOOL))
	Op(OP_OS_WRITE_F64, "os.WriteF64", opOsWriteF64, In(AI32, AF64), Out(ABOOL))
	Op(OP_OS_WRITE_F32, "os.WriteF32", opOsWriteF32, In(AI32, AF32), Out(ABOOL))
	Op(OP_OS_WRITE_UI64, "os.WriteUI64", opOsWriteUI64, In(AI32, AUI64), Out(ABOOL))
	Op(OP_OS_WRITE_UI32, "os.WriteUI32", opOsWriteUI32, In(AI32, AUI32), Out(ABOOL))
	Op(OP_OS_WRITE_UI16, "os.WriteUI16", opOsWriteUI16, In(AI32, AUI16), Out(ABOOL))
	Op(OP_OS_WRITE_UI8, "os.WriteUI8", opOsWriteUI8, In(AI32, AUI8), Out(ABOOL))
	Op(OP_OS_WRITE_I64, "os.WriteI64", opOsWriteI64, In(AI32, AI64), Out(ABOOL))
	Op(OP_OS_WRITE_I32, "os.WriteI32", opOsWriteI32, In(AI32, AI32), Out(ABOOL))
	Op(OP_OS_WRITE_I16, "os.WriteI16", opOsWriteI16, In(AI32, AI16), Out(ABOOL))
	Op(OP_OS_WRITE_I8, "os.WriteI8", opOsWriteI8, In(AI32, AI8), Out(ABOOL))
	Op(OP_OS_WRITE_BOOL, "os.WriteBOOL", opOsWriteBOOL, In(AI32, ABOOL), Out(ABOOL))
	Op(OP_OS_WRITE_F64_SLICE, "os.WriteF64Slice", opOsWriteF64Slice, In(AI32, Slice(TYPE_F64)), Out(ABOOL))
	Op(OP_OS_WRITE_F32_SLICE, "os.WriteF32Slice", opOsWriteF32Slice, In(AI32, Slice(TYPE_F32)), Out(ABOOL))
	Op(OP_OS_WRITE_UI64_SLICE, "os.WriteUI64Slice", opOsWriteUI64Slice, In(AI32, Slice(TYPE_UI64)), Out(ABOOL))
	Op(OP_OS_WRITE_UI32_SLICE, "os.WriteUI32Slice", opOsWriteUI32Slice, In(AI32, Slice(TYPE_UI32)), Out(ABOOL))
	Op(OP_OS_WRITE_UI16_SLICE, "os.WriteUI16Slice", opOsWriteUI16Slice, In(AI32, Slice(TYPE_UI16)), Out(ABOOL))
	Op(OP_OS_WRITE_UI8_SLICE, "os.WriteUI8Slice", opOsWriteUI8Slice, In(AI32, Slice(TYPE_UI8)), Out(ABOOL))
	Op(OP_OS_WRITE_I64_SLICE, "os.WriteI64Slice", opOsWriteI64Slice, In(AI32, Slice(TYPE_I64)), Out(ABOOL))
	Op(OP_OS_WRITE_I32_SLICE, "os.WriteI32Slice", opOsWriteI32Slice, In(AI32, Slice(TYPE_I32)), Out(ABOOL))
	Op(OP_OS_WRITE_I16_SLICE, "os.WriteI16Slice", opOsWriteI16Slice, In(AI32, Slice(TYPE_I16)), Out(ABOOL))
	Op(OP_OS_WRITE_I8_SLICE, "os.WriteI8Slice", opOsWriteI8Slice, In(AI32, Slice(TYPE_I8)), Out(ABOOL))
