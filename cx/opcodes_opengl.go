...
func init() {
	...
	AddOpCode(OP_GL_TEX_IMAGE_2D, "gl.TexImage2D",
		[]*CXArgument{newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice)},
		[]*CXArgument{})
	...
	AddOpCode(OP_GL_BUFFER_DATA, "gl.BufferData",
		[]*CXArgument{newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamF32Slice), newOpPar(opParamI32NotSlice)},
		[]*CXArgument{})
	AddOpCode(OP_GL_BUFFER_SUB_DATA, "gl.BufferSubData",
		[]*CXArgument{newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamI32NotSlice), newOpPar(opParamF32NotSlice)},
		[]*CXArgument{})
