...
func opUI16ToStr(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToI8(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToI16(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToI32(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToI64(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToUI8(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToUI32(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToUI64(inputs []CXValue, outputs []CXValue) {
...
func opUI16ToF32(inputs []CXValue, outputs []CXValue) {
...
func opUI16Sub(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() - inputs[1].Get_ui16()
	outputs[0].Set_ui16(outV0)
}

// The built-in mul function returns the product of two ui16 numbers.
func opUI16Mul(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() * inputs[1].Get_ui16()
	outputs[0].Set_ui16(outV0)
}

// The built-in div function returns the quotient of two ui16 numbers.
func opUI16Div(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() / inputs[1].Get_ui16()
	outputs[0].Set_ui16(outV0)
}

// The built-in gt function returns true if operand 1 is greater than operand 2.
func opUI16Gt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() > inputs[1].Get_ui16()
...
// equal to operand 2.
func opUI16Gteq(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() >= inputs[1].Get_ui16()
	outputs[0].Set_bool(outV0)
}

// The built-in lt function returns true if operand 1 is less than operand 2.
func opUI16Lt(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() < inputs[1].Get_ui16()
	outputs[0].Set_bool(outV0)
}
...
func opUI16Bitshl(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() << inputs[1].Get_ui16()
	outputs[0].Set_ui16(outV0)
}
...
// by number of positions specified in operand 2.
func opUI16Bitshr(inputs []CXValue, outputs []CXValue) {
	outV0 := inputs[0].Get_ui16() >> inputs[1].Get_ui16()
	outputs[0].Set_ui16(outV0)
}

// The built-in max function returns the biggest of the two operands..
func opUI16Max(inputs []CXValue, outputs []CXValue) {
...
// The built-in max function returns the biggest of the two operands.
func opUI16Min(inputs []CXValue, outputs []CXValue) {
	inpV0 := inputs[0].Get_ui16()
	inpV1 := inputs[1].Get_ui16()
	if inpV1 < inpV0 {
		inpV0 = inpV1
