...
func IsTypeStruct(arg *CXArgument) bool {
	...
	return !isThereDeclPointer && !arg.IsSlice() && len(arg.Lengths) == 0 && arg.StructType != nil && len(arg.DeclarationSpecifiers) >= 1 && arg.DeclarationSpecifiers[0] == constants.DECL_STRUCT
}
