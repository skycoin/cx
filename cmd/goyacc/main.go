...
//		-pool               Use sync.Pool for the stage2 stack
...
// Changelog
//
// 2018-03-23: The new option -pool enables using sync.Pool to recycle stage2
// stacks.
//
...
// by parsing code fragments. If it returns true the stage2 exits immediately
// with return value -1.
//
// Overview
//
// The generated stage2 is reentrant and mostly backwards compatible with
...
// the original yacc.
//
// Code inside the stage2 may refer to the variable yylex, which holds the
...
// types, the stage2, and the lexer, generated and referenced by yacc's
...
//
// - Minor changes in stage2 debug output.
//
// Links
//
...
var (
	...
	oOut        = flag.String("o", "y.go", "stage2 output")
	oPool       = flag.Bool("pool", false, "uses sync.Pool to recycle stage2 stacks")
