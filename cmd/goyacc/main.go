...
//		-pool               Use sync.Pool for the cxgo stack
...
// Changelog
//
// 2018-03-23: The new option -pool enables using sync.Pool to recycle cxgo
// stacks.
//
...
// by parsing code fragments. If it returns true the cxgo exits immediately
// with return value -1.
//
// Overview
//
// The generated cxgo is reentrant and mostly backwards compatible with
...
// types, the cxgo, and the lexer, generated and referenced by yacc's
...
//
// - Minor changes in cxgo debug output.
//
// Links
//
...
var (
	...
	oOut        = flag.String("o", "y.go", "cxgo output")
	oPool       = flag.Bool("pool", false, "uses sync.Pool to recycle cxgo stacks")
