...
func glfw_Init (expr *CXExpression, stack *CXStack, fp int) {
	glfw.Init()
}

func glfw_WindowHint (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2 := expr.Inputs[0], expr.Inputs[1]
	glfw.WindowHint(glfw.Hint(ReadI32(stack, fp, inp1)), int(ReadI32(stack, fp, inp2)))
}

func glfw_SetInputMode (expr *CXExpression, stack *CXStack, fp int) {
...
func glfw_MakeContextCurrent (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
...
func glfw_SwapBuffers (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
...
func glfw_SetCursorPosCallback (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2 := expr.Inputs[0], expr.Inputs[1]
...
func glfw_SetShouldClose (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2 := expr.Inputs[0], expr.Inputs[1]
...
func glfw_SetMouseButtonCallback (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2 := expr.Inputs[0], expr.Inputs[1]
