...
func gl_Clear (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
	gl.Clear(uint32(ReadI32(stack, fp, inp1)))
}

func gl_UseProgram (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
	gl.UseProgram(uint32(ReadI32(stack, fp, inp1)))
}

func gl_BindBuffer (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2 := expr.Inputs[0], expr.Inputs[1]
	gl.BindBuffer(uint32(ReadI32(stack, fp, inp1)), uint32(ReadI32(stack, fp, inp2)))
}

func gl_Viewport (expr *CXExpression, stack *CXStack, fp int) {
...
func gl_BindVertexArray (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
...
func gl_EnableVertexAttribArray (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
	gl.EnableVertexAttribArray(uint32(ReadI32(stack, fp, inp1)))
}

func gl_VertexAttribPointer (expr *CXExpression, stack *CXStack, fp int) {
...
func gl_DrawArrays (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2, inp3 := expr.Inputs[0], expr.Inputs[1], expr.Inputs[2]
	gl.DrawArrays(uint32(ReadI32(stack, fp, inp1)), ReadI32(stack, fp, inp2), ReadI32(stack, fp, inp3))
}

func gl_GenBuffers (expr *CXExpression, stack *CXStack, fp int) {
...
func gl_Free (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
...
func gl_ShaderSource (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2, inp3 := expr.Inputs[0], expr.Inputs[1], expr.Inputs[2]
	xstr := cSources[ReadStr(stack, fp, inp3)]
	gl.ShaderSource(uint32(ReadI32(stack, fp, inp1)), ReadI32(stack, fp, inp2), xstr, nil)
}

func gl_CompileShader (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
...
func gl_Rotatef (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2, inp3, inp4 := expr.Inputs[0], expr.Inputs[1], expr.Inputs[2], expr.Inputs[3]
	gl.Rotatef(ReadF32(stack, fp, inp1), ReadF32(stack, fp, inp2), ReadF32(stack, fp, inp3), ReadF32(stack, fp, inp4))
}

func gl_Translatef (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2, inp3 := expr.Inputs[0], expr.Inputs[1], expr.Inputs[2]
	gl.Translatef(ReadF32(stack, fp, inp1), ReadF32(stack, fp, inp2), ReadF32(stack, fp, inp3))
}

func gl_MatrixMode (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
	gl.MatrixMode(uint32(ReadI32(stack, fp, inp1)))
}

func gl_EnableClientState (expr *CXExpression, stack *CXStack, fp int) {
	inp1 := expr.Inputs[0]
	gl.EnableClientState(uint32(ReadI32(stack, fp, inp1)))
}

func gl_BindTexture (expr *CXExpression, stack *CXStack, fp int) {
	inp1, inp2 := expr.Inputs[0], expr.Inputs[1]
	gl.BindTexture(uint32(ReadI32(stack, fp, inp1)), uint32(ReadI32(stack, fp, inp2)))
}

func gl_Ortho (expr *CXExpression, stack *CXStack, fp int) {
