...
func init() {
	...
	// os
	ast.Op_V2(OP_OS_GET_WORKING_DIRECTORY, "os.GetWorkingDirectory", opOsGetWorkingDirectory, nil, Out(ConstCxArg_STR))
	ast.Op_V2(OP_OS_LOG_FILE, "os.LogFile", opOsLogFile, In(ConstCxArg_BOOL), nil)
	ast.Op_V2(OP_OS_OPEN, "os.Open", opOsOpen, In(ConstCxArg_STR), Out(ConstCxArg_I32))
	ast.Op_V2(OP_OS_CREATE, "os.Create", opOsCreate, In(ConstCxArg_STR), Out(ConstCxArg_I32))
	...
	ast.Op_V2(OP_OS_READ_STR, "os.ReadStr", opOsReadStr, In(ConstCxArg_I32), Out(ConstCxArg_STR, ConstCxArg_BOOL))
	...
	ast.Op_V2(OP_OS_READ_ALL_TEXT, "os.ReadAllText", opOsReadAllText, In(ConstCxArg_STR), Out(ConstCxArg_STR, ConstCxArg_BOOL))
	ast.Op_V2(OP_OS_WRITE_STR, "os.WriteStr", opOsWriteStr, In(ConstCxArg_I32, ConstCxArg_STR), Out(ConstCxArg_BOOL))
	...
	ast.Op_V2(OP_OS_RUN, "os.Run", opOsRun, In(ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_STR))
	ast.Op_V2(OP_OS_EXIT, "os.Exit", opOsExit, In(ConstCxArg_I32), nil)

	// json
	ast.Op_V2(OP_JSON_OPEN, "json.Open", opJsonOpen, In(ConstCxArg_STR), Out(ConstCxArg_I32))
	...
	ast.Op_V2(OP_JSON_TOKEN_STR, "json.Str", opJsonTokenStr, In(ConstCxArg_I32), Out(ConstCxArg_STR, ConstCxArg_BOOL))

	// profile
	ast.Op_V2(OP_START_CPU_PROFILE, "StartCPUProfile", opStartProfile, In(ConstCxArg_STR, ConstCxArg_I32), nil)
	ast.Op_V2(OP_STOP_CPU_PROFILE, "StopCPUProfile", opStopProfile, In(ConstCxArg_STR), nil)

	// regexp
	RegisterOpCode(OP_REGEXP_COMPILE, "regexp.Compile", opRegexpCompile, In(ConstCxArg_STR), Out(Struct("regexp", "Regexp", "r"), ConstCxArg_STR))
	RegisterOpCode(OP_REGEXP_MUST_COMPILE, "regexp.MustCompile", opRegexpMustCompile, In(ConstCxArg_STR), Out(Struct("regexp", "Regexp", "r")))
	RegisterOpCode(OP_REGEXP_FIND, "regexp.Regexp.Find", opRegexpFind, In(Struct("regexp", "Regexp", "r"), ConstCxArg_STR), Out(ConstCxArg_STR))
