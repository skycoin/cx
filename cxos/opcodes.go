...
func init() {
	...
	Op_V2(OP_OS_READ_F64_SLICE, "os.ReadF64Slice", opOsReadF64Slice, In(AI32, Slice(TYPE_F64), AUI64), Out(Slice(TYPE_F64), ABOOL))
	Op_V2(OP_OS_READ_F32_SLICE, "os.ReadF32Slice", opOsReadF32Slice, In(AI32, Slice(TYPE_F32), AUI64), Out(Slice(TYPE_F32), ABOOL))
	Op_V2(OP_OS_READ_UI64_SLICE, "os.ReadUI64Slice", opOsReadUI64Slice, In(AI32, Slice(TYPE_UI64), AUI64), Out(Slice(TYPE_UI64), ABOOL))
	Op_V2(OP_OS_READ_UI32_SLICE, "os.ReadUI32Slice", opOsReadUI32Slice, In(AI32, Slice(TYPE_UI32), AUI64), Out(Slice(TYPE_UI32), ABOOL))
	Op_V2(OP_OS_READ_UI16_SLICE, "os.ReadUI16Slice", opOsReadUI16Slice, In(AI32, Slice(TYPE_UI16), AUI64), Out(Slice(TYPE_UI16), ABOOL))
	Op_V2(OP_OS_READ_UI8_SLICE, "os.ReadUI8Slice", opOsReadUI8Slice, In(AI32, Slice(TYPE_UI8), AUI64), Out(Slice(TYPE_UI8), ABOOL))
	Op_V2(OP_OS_READ_I64_SLICE, "os.ReadI64Slice", opOsReadI64Slice, In(AI32, Slice(TYPE_I64), AUI64), Out(Slice(TYPE_I64), ABOOL))
	Op_V2(OP_OS_READ_I32_SLICE, "os.ReadI32Slice", opOsReadI32Slice, In(AI32, Slice(TYPE_I32), AUI64), Out(Slice(TYPE_I32), ABOOL))
	Op_V2(OP_OS_READ_I16_SLICE, "os.ReadI16Slice", opOsReadI16Slice, In(AI32, Slice(TYPE_I16), AUI64), Out(Slice(TYPE_I16), ABOOL))
	Op_V2(OP_OS_READ_I8_SLICE, "os.ReadI8Slice", opOsReadI8Slice, In(AI32, Slice(TYPE_I8), AUI64), Out(Slice(TYPE_I8), ABOOL))
	...
	Op_V2(OP_OS_WRITE_F64_SLICE, "os.WriteF64Slice", opOsWriteF64Slice, In(AI32, Slice(TYPE_F64)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_F32_SLICE, "os.WriteF32Slice", opOsWriteF32Slice, In(AI32, Slice(TYPE_F32)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_UI64_SLICE, "os.WriteUI64Slice", opOsWriteUI64Slice, In(AI32, Slice(TYPE_UI64)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_UI32_SLICE, "os.WriteUI32Slice", opOsWriteUI32Slice, In(AI32, Slice(TYPE_UI32)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_UI16_SLICE, "os.WriteUI16Slice", opOsWriteUI16Slice, In(AI32, Slice(TYPE_UI16)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_UI8_SLICE, "os.WriteUI8Slice", opOsWriteUI8Slice, In(AI32, Slice(TYPE_UI8)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_I64_SLICE, "os.WriteI64Slice", opOsWriteI64Slice, In(AI32, Slice(TYPE_I64)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_I32_SLICE, "os.WriteI32Slice", opOsWriteI32Slice, In(AI32, Slice(TYPE_I32)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_I16_SLICE, "os.WriteI16Slice", opOsWriteI16Slice, In(AI32, Slice(TYPE_I16)), Out(ABOOL))
	Op_V2(OP_OS_WRITE_I8_SLICE, "os.WriteI8Slice", opOsWriteI8Slice, In(AI32, Slice(TYPE_I8)), Out(ABOOL))
