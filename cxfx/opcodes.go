...
func init() {
	...
	ast.Op_V2(OP_GL_APPEND_F32, "gl.AppendF32", opGlAppend, In(ast.Slice(constants.TYPE_UI8), AF32), Out(ast.Slice(constants.TYPE_UI8)))
	ast.Op_V2(OP_GL_APPEND_UI16, "gl.AppendUI16", opGlAppend, In(ast.Slice(constants.TYPE_UI8), AUI16), Out(ast.Slice(constants.TYPE_UI8)))
	ast.Op_V2(OP_GL_APPEND_UI32, "gl.AppendUI32", opGlAppend, In(ast.Slice(constants.TYPE_UI8), AUI32), Out(ast.Slice(constants.TYPE_UI8)))
	...
	ast.Op_V2(OP_GL_TEX_IMAGE_2D, "gl.TexImage2D", opGlTexImage2D, In(AI32, AI32, AI32, AI32, AI32, AI32, AI32, AI32, ast.Slice(constants.TYPE_UI32)), nil)
	...
	ast.Op_V2(OP_GL_BUFFER_DATA, "gl.BufferData", opGlBufferData, In(AI32, AI32, ast.Slice(constants.TYPE_UI8), AI32), nil)
	ast.Op_V2(OP_GL_BUFFER_SUB_DATA, "gl.BufferSubData", opGlBufferSubData, In(AI32, AI32, AI32, ast.Slice(constants.TYPE_UI8)), nil)

	//gl_2_0
	ast.Op_V2(OP_GL_DRAW_BUFFERS, "gl.DrawBuffers", opGlDrawBuffers, In(AI32, ast.Slice(constants.TYPE_UI32)), nil)
	...
	ast.Op_V2(OP_GL_UNIFORM_1FV, "gl.Uniform1fv", opGlUniform1fv, In(AI32, AF32, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_2FV, "gl.Uniform2fv", opGlUniform2fv, In(AI32, AF32, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_3FV, "gl.Uniform3fv", opGlUniform3fv, In(AI32, AI32, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_4FV, "gl.Uniform4fv", opGlUniform4fv, In(AI32, AI32, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_1IV, "gl.Uniform1iv", opGlUniform1iv, In(AI32, AI32, ast.Slice(constants.TYPE_I32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_2IV, "gl.Uniform2iv", opGlUniform2iv, In(AI32, AI32, ast.Slice(constants.TYPE_I32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_3IV, "gl.Uniform3iv", opGlUniform3iv, In(AI32, AI32, ast.Slice(constants.TYPE_I32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_4IV, "gl.Uniform4iv", opGlUniform4iv, In(AI32, AI32, ast.Slice(constants.TYPE_I32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_MATRIX_2FV, "gl.UniformMatrix2fv", opGlUniformMatrix2fv, In(AI32, AI32, ABOOL, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_MATRIX_3FV, "gl.UniformMatrix3fv", opGlUniformMatrix3fv, In(AI32, AI32, ABOOL, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_MATRIX_4FV, "gl.UniformMatrix4fv", opGlUniformMatrix4fv, In(AI32, AI32, ABOOL, ast.Slice(constants.TYPE_F32)), nil)
	...
	ast.Op_V2(OP_GL_UNIFORM_M44FV, "gl.UniformM44FV", opGlUniformM44FV, In(AI32, AI32, ABOOL, ast.Slice(constants.TYPE_UNDEFINED)), nil)
	...
	// goal
	ast.Op_V2(OP_AL_LOAD_WAV, "al.LoadWav", opAlLoadWav, In(ASTR), Out(AI32, AI32, AI32, AI32, AI32, AI32, AI32, AI64, ast.Slice(constants.TYPE_UI8)))
	...
	ast.Op_V2(OP_AL_GEN_BUFFERS, "al.GenBuffers", opAlGenBuffers, In(AI32), Out(ast.Slice(constants.TYPE_I32)))
	ast.Op_V2(OP_AL_BUFFER_DATA, "al.BufferData", opAlBufferData, In(AI32, AI32, AUND, AI32), nil)
	ast.Op_V2(OP_AL_GEN_SOURCES, "al.GenSources", opAlGenSources, In(AI32), Out(ast.Slice(constants.TYPE_I32)))
	...
	ast.Op_V2(OP_AL_SOURCE_QUEUE_BUFFERS, "al.SourceQueueBuffers", opAlSourceQueueBuffers, In(AI32, ast.Slice(constants.TYPE_I32)), nil)
	ast.Op_V2(OP_AL_SOURCE_STATE, "al.SourceState", opAlSourceState, In(AI32), Out(AI32))
	ast.Op_V2(OP_AL_SOURCE_UNQUEUE_BUFFERS, "al.SourceUnqueueBuffers", opAlSourceUnqueueBuffers, In(AI32, ast.Slice(constants.TYPE_I32)), nil)
}
