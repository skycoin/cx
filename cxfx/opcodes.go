...
func init() {
	...
	ast.Op_V2(OP_GL_STRS, "gl.Strs", opGlStrs, In(ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GL_FREE, "gl.Free", opGlFree, In(ConstCxArg_STR), nil)
	ast.Op_V2(OP_GL_NEW_TEXTURE, "gl.NewTexture", opGlNewTexture, In(ConstCxArg_STR), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GL_NEW_TEXTURE_CUBE, "gl.NewTextureCube", opGlNewTextureCube, In(ConstCxArg_STR, ConstCxArg_STR), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GL_NEW_GIF, "gl.NewGIF", opGlNewGIF, In(ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GL_FREE_GIF, "gl.FreeGIF", opGlFreeGIF, In(ConstCxArg_STR), nil)
	ast.Op_V2(OP_GL_GIF_FRAME_TO_TEXTURE, "gl.GIFFrameToTexture", opGlGIFFrameToTexture, In(ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32), Out(ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GL_UPLOAD_IMAGE_TO_TEXTURE, "gl.UploadImageToTexture", opGlUploadImageToTexture, In(ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_BOOL), nil)
	ast.Op_V2(OP_CX_RELEASE_TEXTURE, "gl.CxReleaseTexture", opCxReleaseTexture, In(ConstCxArg_STR), nil)
	ast.Op_V2(OP_CX_TEXTURE_GET_PIXEL, "gl.CxTextureGetPixel", opCxTextureGetPixel, In(ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32), Out(ConstCxArg_F32, ConstCxArg_F32, ConstCxArg_F32, ConstCxArg_F32))
	...
	ast.Op_V2(OP_GL_BIND_ATTRIB_LOCATION, "gl.BindAttribLocation", opGlBindAttribLocation, In(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_STR), nil)
	...
	ast.Op_V2(OP_GL_GET_ATTRIB_LOCATION, "gl.GetAttribLocation", opGlGetAttribLocation, In(ConstCxArg_I32, ConstCxArg_STR), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GL_GET_PROGRAMIV, "gl.GetProgramiv", opGlGetProgramiv, In(ConstCxArg_I32, ConstCxArg_I32), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GL_GET_PROGRAM_INFO_LOG, "gl.GetProgramInfoLog", opGlGetProgramInfoLog, In(ConstCxArg_I32, ConstCxArg_I32), Out(ConstCxArg_STR))
	ast.Op_V2(OP_GL_GET_SHADERIV, "gl.GetShaderiv", opGlGetShaderiv, In(ConstCxArg_I32, ConstCxArg_I32), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GL_GET_SHADER_INFO_LOG, "gl.GetShaderInfoLog", opGlGetShaderInfoLog, In(ConstCxArg_I32, ConstCxArg_I32), Out(ConstCxArg_STR))
	ast.Op_V2(OP_GL_GET_UNIFORM_LOCATION, "gl.GetUniformLocation", opGlGetUniformLocation, In(ConstCxArg_I32, ConstCxArg_STR), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GL_LINK_PROGRAM, "gl.LinkProgram", opGlLinkProgram, In(ConstCxArg_I32), nil)
	ast.Op_V2(OP_GL_SHADER_SOURCE, "gl.ShaderSource", opGlShaderSource, In(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_STR), nil)
	...
	ast.Op_V2(OP_GL_UNIFORM_V4F, "gl.UniformV4F", opGlUniformV4F, In(ConstCxArg_I32, ConstCxArg_UND_TYPE), nil)
	ast.Op_V2(OP_GL_UNIFORM_M44F, "gl.UniformM44F", opGlUniformM44F, In(ConstCxArg_I32, ConstCxArg_BOOL, ConstCxArg_UND_TYPE), nil)
	...
	// goglfw
	ast.Op_V2(OP_GLFW_FULLSCREEN, "glfw.Fullscreen", opGlfwFullscreen, In(ConstCxArg_STR, ConstCxArg_BOOL, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32), nil)
	...
	ast.Op_V2(OP_GLFW_CREATE_WINDOW, "glfw.CreateWindow", opGlfwCreateWindow, In(ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_MAKE_CONTEXT_CURRENT, "glfw.MakeContextCurrent", opGlfwMakeContextCurrent, In(ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SHOULD_CLOSE, "glfw.ShouldClose", opGlfwShouldClose, In(ConstCxArg_STR), Out(ConstCxArg_BOOL))
	ast.Op_V2(OP_GLFW_SET_SHOULD_CLOSE, "glfw.SetShouldClose", opGlfwSetShouldClose, In(ConstCxArg_STR, ConstCxArg_BOOL), nil)
	ast.Op_V2(OP_GLFW_POLL_EVENTS, "glfw.PollEvents", opGlfwPollEvents, nil, nil)
	ast.Op_V2(OP_GLFW_SWAP_BUFFERS, "glfw.SwapBuffers", opGlfwSwapBuffers, In(ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_GET_FRAMEBUFFER_SIZE, "glfw.GetFramebufferSize", opGlfwGetFramebufferSize, In(ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GLFW_GET_WINDOW_POS, "glfw.GetWindowPos", opGlfwGetWindowPos, In(ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GLFW_GET_WINDOW_SIZE, "glfw.GetWindowSize", opGlfwGetWindowSize, In(ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32))
	...
	ast.Op_V2(OP_GLFW_SET_START_CALLBACK, "glfw.SetStartCallback", opGlfwSetStartCallback, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SET_STOP_CALLBACK, "glfw.SetStopCallback", opGlfwSetStopCallback, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SET_KEYBOARD_CALLBACK, "glfw.SetKeyboardCallback", opGlfwSetKeyboardCallback, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SET_MOUSE_CALLBACK, "glfw.SetMouseCallback", opGlfwSetMouseCallback, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SET_FRAMEBUFFER_SIZE_CALLBACK, "glfw.SetFramebufferSizeCallback", opGlfwSetFramebufferSizeCallback, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SET_WINDOW_POS_CALLBACK, "glfw.SetWindowPosCallback", opGlfwSetWindowPosCallback, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SET_WINDOW_SIZE_CALLBACK, "glfw.SetWindowSizeCallback", opGlfwSetWindowSizeCallback, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLFW_SET_KEY_CALLBACK, "glfw.SetKeyCallback", opGlfwSetKeyCallback, In(ConstCxArg_STR, ConstCxArg_STR), nil)                          // TODO : to deprecate
	ast.Op_V2(OP_GLFW_SET_MOUSE_BUTTON_CALLBACK, "glfw.SetMouseButtonCallback", opGlfwSetMouseButtonCallback, In(ConstCxArg_STR, ConstCxArg_STR), nil) // TODO : to deprecate
	ast.Op_V2(OP_GLFW_SET_CURSOR_POS_CALLBACK, "glfw.SetCursorPosCallback", opGlfwSetCursorPosCallback, In(ConstCxArg_STR, ConstCxArg_STR), nil)       // TODO : to deprecate
	ast.Op_V2(OP_GLFW_GET_CURSOR_POS, "glfw.GetCursorPos", opGlfwGetCursorPos, In(ConstCxArg_STR), Out(ConstCxArg_F64, ConstCxArg_F64))
	ast.Op_V2(OP_GLFW_SET_INPUT_MODE, "glfw.SetInputMode", opGlfwSetInputMode, In(ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32), nil)
	ast.Op_V2(OP_GLFW_SET_WINDOW_POS, "glfw.SetWindowPos", opGlfwSetWindowPos, In(ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32), nil)
	ast.Op_V2(OP_GLFW_GET_KEY, "glfw.GetKey", opGlfwGetKey, In(ConstCxArg_STR, ConstCxArg_I32), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GLFW_FUNC_I32_I32, "glfw.func_i32_i32", opGlfwFuncI32I32, In(ConstCxArg_STR, ConstCxArg_STR), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GLFW_CALL_I32_I32, "glfw.call_i32_i32", opGlfwCallI32I32, In(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32), nil)
	ast.Op_V2(OP_GLFW_GET_WINDOW_CONTENT_SCALE, "glfw.GetWindowContentScale", opGlfwGetWindowContentScale, In(ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32))
	...
	// gltext
	ast.Op_V2(OP_GLTEXT_LOAD_TRUE_TYPE, "gltext.LoadTrueType", opGltextLoadTrueType, In(ConstCxArg_I32, ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32), nil)
	ast.Op_V2(OP_GLTEXT_LOAD_TRUE_TYPE_CORE, "gltext.LoadTrueTypeCore", opGltextLoadTrueTypeCore, In(ConstCxArg_I32, ConstCxArg_STR, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32), nil)
	ast.Op_V2(OP_GLTEXT_PRINTF, "gltext.Printf", opGltextPrintf, In(ConstCxArg_STR, ConstCxArg_F32, ConstCxArg_F32, ConstCxArg_STR), nil)
	ast.Op_V2(OP_GLTEXT_METRICS, "gltext.Metrics", opGltextMetrics, In(ConstCxArg_STR, ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GLTEXT_TEXTURE, "gltext.Texture", opGltextTexture, In(ConstCxArg_STR), Out(ConstCxArg_I32))
	ast.Op_V2(OP_GLTEXT_NEXT_GLYPH, "gltext.NextGlyph", opGltextNextGlyph, In(ConstCxArg_STR, ConstCxArg_STR, ConstCxArg_I32), Out(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GLTEXT_GLYPH_BOUNDS, "gltext.GlyphBounds", opGltextGlyphBounds, nil, Out(ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GLTEXT_GLYPH_METRICS, "gltext.GlyphMetrics", opGltextGlyphMetrics, In(ConstCxArg_STR, ConstCxArg_I32), Out(ConstCxArg_I32, ConstCxArg_I32))
	ast.Op_V2(OP_GLTEXT_GLYPH_INFO, "gltext.GlyphInfo", opGltextGlyphInfo, In(ConstCxArg_STR, ConstCxArg_I32), Out(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32))

	// goal
	ast.Op_V2(OP_AL_LOAD_WAV, "al.LoadWav", opAlLoadWav, In(ConstCxArg_STR), Out(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I64, ast.Slice(constants.TYPE_UI8)))
	...
	ast.Op_V2(OP_AL_EXTENSIONS, "al.Extensions", opAlExtensions, nil, Out(ConstCxArg_STR))
	...
	ast.Op_V2(OP_AL_RENDERER, "al.Renderer", opAlRenderer, nil, Out(ConstCxArg_STR))
	...
	ast.Op_V2(OP_AL_VENDOR, "al.Vendor", opAlVendor, nil, Out(ConstCxArg_STR))
	ast.Op_V2(OP_AL_VERSION, "al.Version", opAlVersion, nil, Out(ConstCxArg_STR))
	ast.Op_V2(OP_AL_GEN_BUFFERS, "al.GenBuffers", opAlGenBuffers, In(ConstCxArg_I32), Out(ast.Slice(constants.TYPE_I32)))
	ast.Op_V2(OP_AL_BUFFER_DATA, "al.BufferData", opAlBufferData, In(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_UND_TYPE, ConstCxArg_I32), nil)
