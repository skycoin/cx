...
func init() {
	...
	ast.Op_V2(OP_GL_UPLOAD_IMAGE_TO_TEXTURE, "gl.UploadImageToTexture", opGlUploadImageToTexture, In(ASTR, ConstCxArg_I32, ConstCxArg_I32, ABOOL), nil)
	ast.Op_V2(OP_CX_RELEASE_TEXTURE, "gl.CxReleaseTexture", opCxReleaseTexture, In(ASTR), nil)
	ast.Op_V2(OP_CX_TEXTURE_GET_PIXEL, "gl.CxTextureGetPixel", opCxTextureGetPixel, In(ASTR, ConstCxArg_I32, ConstCxArg_I32), Out(AF32, AF32, AF32, AF32))
	...
	ast.Op_V2(OP_GL_UNIFORM_1F, "gl.Uniform1f", opGlUniform1f, In(ConstCxArg_I32, AF32), nil)
	ast.Op_V2(OP_GL_UNIFORM_2F, "gl.Uniform2f", opGlUniform2f, In(ConstCxArg_I32, AF32, AF32), nil)
	ast.Op_V2(OP_GL_UNIFORM_3F, "gl.Uniform3f", opGlUniform3f, In(ConstCxArg_I32, AF32, AF32, AF32), nil)
	ast.Op_V2(OP_GL_UNIFORM_4F, "gl.Uniform4f", opGlUniform4f, In(ConstCxArg_I32, AF32, AF32, AF32, AF32), nil)
	...
	ast.Op_V2(OP_GL_UNIFORM_1FV, "gl.Uniform1fv", opGlUniform1fv, In(ConstCxArg_I32, AF32, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_2FV, "gl.Uniform2fv", opGlUniform2fv, In(ConstCxArg_I32, AF32, ast.Slice(constants.TYPE_F32)), nil)
	...
	ast.Op_V2(OP_GL_UNIFORM_MATRIX_2FV, "gl.UniformMatrix2fv", opGlUniformMatrix2fv, In(ConstCxArg_I32, ConstCxArg_I32, ABOOL, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_MATRIX_3FV, "gl.UniformMatrix3fv", opGlUniformMatrix3fv, In(ConstCxArg_I32, ConstCxArg_I32, ABOOL, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_MATRIX_4FV, "gl.UniformMatrix4fv", opGlUniformMatrix4fv, In(ConstCxArg_I32, ConstCxArg_I32, ABOOL, ast.Slice(constants.TYPE_F32)), nil)
	ast.Op_V2(OP_GL_UNIFORM_V4F, "gl.UniformV4F", opGlUniformV4F, In(ConstCxArg_I32, AUND), nil)
	ast.Op_V2(OP_GL_UNIFORM_M44F, "gl.UniformM44F", opGlUniformM44F, In(ConstCxArg_I32, ABOOL, AUND), nil)
	ast.Op_V2(OP_GL_UNIFORM_M44FV, "gl.UniformM44FV", opGlUniformM44FV, In(ConstCxArg_I32, ConstCxArg_I32, ABOOL, ast.Slice(constants.TYPE_UNDEFINED)), nil)
	ast.Op_V2(OP_GL_VERTEX_ATTRIB_POINTER, "gl.VertexAttribPointer", opGlVertexAttribPointer, In(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ABOOL, ConstCxArg_I32), nil)
	ast.Op_V2(OP_GL_VERTEX_ATTRIB_POINTER_I32, "gl.VertexAttribPointerI32", opGlVertexAttribPointerI32, In(ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ABOOL, ConstCxArg_I32, ConstCxArg_I32), nil)
	...
	ast.Op_V2(OP_GL_CLEAR_BUFFER_UI, "gl.ClearBufferUI", opGlClearBufferUI, In(ConstCxArg_I32, ConstCxArg_I32, AUI32, AUI32, AUI32, AUI32), nil)
	ast.Op_V2(OP_GL_CLEAR_BUFFER_F, "gl.ClearBufferF", opGlClearBufferF, In(ConstCxArg_I32, ConstCxArg_I32, AF32, AF32, AF32, AF32), nil)
	...
	// goglfw
	ast.Op_V2(OP_GLFW_FULLSCREEN, "glfw.Fullscreen", opGlfwFullscreen, In(ASTR, ABOOL, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32, ConstCxArg_I32), nil)
